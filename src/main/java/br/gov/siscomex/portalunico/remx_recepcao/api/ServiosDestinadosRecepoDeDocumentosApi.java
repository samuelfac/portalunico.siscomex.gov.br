package br.gov.siscomex.portalunico.remx_recepcao.api;

import br.gov.siscomex.portalunico.remx_recepcao.model.ManifestoDePresenaDeCarga;
import br.gov.siscomex.portalunico.remx_recepcao.model.ProtocoloDeEnvioDeDocumento;
...
public interface ServiosDestinadosRecepoDeDocumentosApi  {
    ...
    @Produces({ "*/*" })
    @ApiOperation(value = "Envio de Manifesto de Presença de Carga", notes = "", tags={ "Serviços destinados à recepção de documentos" })
    @ApiResponses(value = {
