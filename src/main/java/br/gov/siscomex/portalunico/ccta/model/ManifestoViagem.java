...
@XmlType(name = "ManifestoViagem", propOrder =
        {"crts", "licencaComplementarTransportador", "placaCavalo", "paisProprietarioVeiculoEstrangeiro", "visualizacaoDepositario", "condutorBrasileiro", "transportadorNacBrasileira", "identificacaoProprietarioVeiculo", "observacoesVeiculo", "cidadeTransportadorEstrangeiro", "ruaProprietarioVeiculoEstrangeiro", "aplicacaoLacres", "cavaloPropriaMercadoria", "tipoNumeroDocumentoViagem", "cidadeDestinoFinal", "cidadeProprietarioVeiculoEstrangeiro", "proprietarioVeiculoBrasileiro", "tipoTratamentoMadeiraBruta", "transportadorProprietarioVeiculo", "identificacaoRepresentanteTransportadorEstrangeiro", "licencaComplementarProprietario", "tipoDocumentoCondutorVeiculo", "bairroTransportadorEstrangeiro", "reboques", "cidadePartida", "dataVencimentoSeguro", "licencaOriginariaProprietario", "paisDestinoFinal", "paisTransportadorEstrangeiro", "nomeProprietarioVeiculoEstrangeiro", "numeroDocumentoTransporte", "tipoTransporte", "descricaoRotaInternacional", "transportadorImportador", "conteineresVazios", "licencaOriginariaTransportador", "nomeCondutorVeiculoEstrangeiro", "tipoVeiculo", "marcaVeiculo", "recintoEntrada", "tipoDocumentoTransporte", "codigoPostalTransportadorEstrangeiro", "acompanhantesCondutor", "bairroProprietarioVeiculoEstrangeiro", "dataEmissao", "estadoTransportadorEstrangeiro", "taraCavalo", "dataPrevistaEntrada", "lacresVeiculo", "numeroDocumentoCondutorVeiculo", "identificacaoTransportadorEstrangeiro", "chassiVeiculo", "ulEntrada", "anoFabricacaoVeiculo", "ruaTransportadorEstrangeiro", "transitoInternacional", "nomeTransportadorEstrangeiro", "paisPartida", "capacidadeTracaoVeiculo", "estadoProprietarioVeiculoEstrangeiro", "localAssinaturaTransportador", "possuiEmbalagemSuporteMadeiraBruta", "numeroDTAExterior", "dataPrevistaDestinoFinal", "nomeAssinaturaTransportador", "identificacaoTransportadorNacional", "codigoPostalProprietarioVeiculoEstrangeiro", "apoliceSeguro", "observacoesGerais", "alfandegaPartida"
        })
