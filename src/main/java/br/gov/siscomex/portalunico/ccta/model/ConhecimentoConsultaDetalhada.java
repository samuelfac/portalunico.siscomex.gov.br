...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "ConhecimentoConsultaDetalhada", propOrder =
    { "manuseiosEspeciais", "solicitacoesServicosEspeciais", "outrasInfosServico", "tipo", "identificacao", "situacao", "dataEmissao", "cnpjResponsavelArquivo", "descricaoResumida", "quantidadeVolumesConhecimento", "pesoBrutoConhecimento", "documentosSaida", "indicadorPartesMadeira", "indicadorRecepcaoHawbAssociados", "itensCarga", "recintoAduaneiroDestino", "ruc", "categoriaCarga", "codigoAeroportoOrigemConhecimento", "codigoAeroportoDestinoConhecimento", "nomeAssinaturaEmbarcadorEstrangeiro", "dataHoraAssinaturaTransportador", "localAssinaturaTransportador", "nomeAssinaturaTransportador", "tipoDocumentoConsignatario", "identificacaoDocumentoConsignatario", "nomeDocumentoConsignatario", "razaoSocialDocumentoConsignatario", "nomeConsignatarioConhecimento", "enderecoConsignatarioConhecimento", "caixaPostalConsignatarioConhecimento", "cidadeConsignatarioConhecimento", "paisConsignatarioConhecimento", "contatosConsignatario", "outrasPartesInteressadas", "bloqueiosAtivos", "bloqueiosBaixados", "hawbAssociados", "mawbAwbAssociados", "estoques", "viagensAssociadas", "dsicsApropriados"
})
...
@XmlType(name="IndicadorRecepcaoHawbAssociadosEnum")
@XmlEnum(String.class)
public enum IndicadorRecepcaoHawbAssociadosEnum {
    ...
    IndicadorRecepcaoHawbAssociadosEnum (String v) {
        value = v;
    }
    ...
    public static IndicadorRecepcaoHawbAssociadosEnum fromValue(String v) {
        for (IndicadorRecepcaoHawbAssociadosEnum b : IndicadorRecepcaoHawbAssociadosEnum.values()) {
            if (String.valueOf(b.value).equals(v)) {
                return b;
            }
        }
        throw new IllegalArgumentException("Unexpected value '" + v + "' to IndicadorRecepcaoHawbAssociadosEnum");
    }
}

  @XmlElement(name="indicadorRecepcaoHawbAssociados")
  ...
  **/
  private IndicadorRecepcaoHawbAssociadosEnum indicadorRecepcaoHawbAssociados = null;
...
public enum TipoDocumentoConsignatarioEnum {
  ...
  **/
  ...
  @XmlElement(name="contatosConsignatario")
  @ApiModelProperty(value = "Lista de contatos do consignatário.")
  @Valid
 /**
   * Lista de contatos do consignatário.
  **/
  private List<ContatosConsultaDetalhadaRepresentation> contatosConsignatario = null;
  ...
  **/
  private List<ParteInteressadaConsultaDetalhadaRepresentation> outrasPartesInteressadas = null;
  ...
  **/
  private List<HawbMawbAssociadoConsultaDetalhada> mawbAwbAssociados = null;
 ...
 /**
   * Indicador relacionado à recepção de todos os cargas relacionadas&lt;br/&gt; 
   * @return indicadorRecepcaoHawbAssociados
  **/
  @JsonProperty("indicadorRecepcaoHawbAssociados")
  public String getIndicadorRecepcaoHawbAssociados() {
    if (indicadorRecepcaoHawbAssociados == null) {
      return null;
    }
    return indicadorRecepcaoHawbAssociados.value();
  }

  public void setIndicadorRecepcaoHawbAssociados(IndicadorRecepcaoHawbAssociadosEnum indicadorRecepcaoHawbAssociados) {
    this.indicadorRecepcaoHawbAssociados = indicadorRecepcaoHawbAssociados;
  }

  public ConhecimentoConsultaDetalhada indicadorRecepcaoHawbAssociados(IndicadorRecepcaoHawbAssociadosEnum indicadorRecepcaoHawbAssociados) {
    this.indicadorRecepcaoHawbAssociados = indicadorRecepcaoHawbAssociados;
    return this;
  }
 ...
 /**
   * Lista de contatos do consignatário.
   * @return contatosConsignatario
  **/
  @JsonProperty("contatosConsignatario")
  public List<ContatosConsultaDetalhadaRepresentation> getContatosConsignatario() {
    return contatosConsignatario;
  }

  public void setContatosConsignatario(List<ContatosConsultaDetalhadaRepresentation> contatosConsignatario) {
    this.contatosConsignatario = contatosConsignatario;
  }

  public ConhecimentoConsultaDetalhada contatosConsignatario(List<ContatosConsultaDetalhadaRepresentation> contatosConsignatario) {
    this.contatosConsignatario = contatosConsignatario;
    return this;
  }

  public ConhecimentoConsultaDetalhada addContatosConsignatarioItem(ContatosConsultaDetalhadaRepresentation contatosConsignatarioItem) {
    this.contatosConsignatario.add(contatosConsignatarioItem);
    return this;
  }
  ...
  **/
  ...
  public List<ParteInteressadaConsultaDetalhadaRepresentation> getOutrasPartesInteressadas() {
    return outrasPartesInteressadas;
  }

  public void setOutrasPartesInteressadas(List<ParteInteressadaConsultaDetalhadaRepresentation> outrasPartesInteressadas) {
    this.outrasPartesInteressadas = outrasPartesInteressadas;
  }

  public ConhecimentoConsultaDetalhada outrasPartesInteressadas(List<ParteInteressadaConsultaDetalhadaRepresentation> outrasPartesInteressadas) {
    this.outrasPartesInteressadas = outrasPartesInteressadas;
    return this;
  }

  public ConhecimentoConsultaDetalhada addOutrasPartesInteressadasItem(ParteInteressadaConsultaDetalhadaRepresentation outrasPartesInteressadasItem) {
  ...
  **/
  ...
  public List<HawbMawbAssociadoConsultaDetalhada> getMawbAwbAssociados() {
    return mawbAwbAssociados;
  }

  public void setMawbAwbAssociados(List<HawbMawbAssociadoConsultaDetalhada> mawbAwbAssociados) {
    this.mawbAwbAssociados = mawbAwbAssociados;
  }

  public ConhecimentoConsultaDetalhada mawbAwbAssociados(List<HawbMawbAssociadoConsultaDetalhada> mawbAwbAssociados) {
    this.mawbAwbAssociados = mawbAwbAssociados;
    return this;
  }

  public ConhecimentoConsultaDetalhada addMawbAwbAssociadosItem(HawbMawbAssociadoConsultaDetalhada mawbAwbAssociadosItem) {
  ...
  **/
  ...
  public ConhecimentoConsultaDetalhada estoques(List<EstoqueConsultaDetalhada> estoques) {
    this.estoques = estoques;
    return this;
  }

  public ConhecimentoConsultaDetalhada addEstoquesItem(EstoqueConsultaDetalhada estoquesItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    indicadorRecepcaoHawbAssociados: ").append(toIndentedString(indicadorRecepcaoHawbAssociados)).append("\n");
    ...
    sb.append("    contatosConsignatario: ").append(toIndentedString(contatosConsignatario)).append("\n");
