...
import br.gov.siscomex.portalunico.ccta.model.DsicConsultaDetalhada;
...
public interface ServicosDeConsultaDeDsicApi {
    ...
    @ApiOperation(value = "Retorna o detalhamento de um DSIC.", notes = "Retorna o detalhamento de um DSIC.", tags = {"Servicos de Consulta de DSIC"})
    @ApiResponses(value = {
