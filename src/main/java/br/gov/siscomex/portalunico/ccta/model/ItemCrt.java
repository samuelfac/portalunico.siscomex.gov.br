...
@XmlType(name = "ItemCrt", propOrder =
        {"embalagemVazia", "qtdeVolumesTotalManifestada", "sequencial", "tipoEmbalagem", "tipoTratamentoMadeiraBruta", "medidaConteiner", "contramarca", "numeroConteiner", "taraConteiner", "conteinerVazio", "descricao", "possuiEmbalagemSuporteMadeiraBruta", "marca", "numeroChassiVeiculo", "pesoBrutoKg", "pesoLiquido", "tipoGranel"
        })
