...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "RetornoSolicitacaEntregaImportador", propOrder =
    { "numeroProtocolo"
})

@XmlRootElement(name="RetornoSolicitacaEntregaImportador")
/**
  * Retorno da solicitação de entrega da carga.
 **/
@ApiModel(description="Retorno da solicitação de entrega da carga.")
public class RetornoSolicitacaEntregaImportador  {
  ...
  **/
  ...
  public RetornoSolicitacaEntregaImportador numeroProtocolo(String numeroProtocolo) {
    this.numeroProtocolo = numeroProtocolo;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RetornoSolicitacaEntregaImportador {\n");
