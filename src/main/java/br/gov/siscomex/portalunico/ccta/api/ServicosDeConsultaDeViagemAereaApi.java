...
public interface ServicosDeConsultaDeViagemAereaApi {
    ...
    @Produces({"application/json"})
    @ApiOperation(value = "Retorna o detalhamento de uma viagem.", notes = "Retorna o detalhamento de uma viagem.", tags = {"Servicos de Consulta de Viagem Aerea"})
    @ApiResponses(value = {
