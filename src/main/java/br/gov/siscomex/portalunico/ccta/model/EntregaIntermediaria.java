...
@XmlType(name = "EntregaIntermediaria", propOrder =
        {"tipoDTA", "tipoRecebedor", "pesoEntrega", "tipoCarga", "cpfRecebedor", "dataEmissao", "observacoes", "cnpjResponsavelArquivo", "volumeEntrega", "identificacaoCarga", "detalheMotivo", "recintoAduaneiro", "unidadeRFB", "cnpjRecebedor", "cnpjResponsavelEntregaIntermediaria", "motivoEntregaIntermediaria", "numeroDTA"
        })
...
public class EntregaIntermediaria {
    ...
    public String toString() {
        ...
        String sb = "class EntregaIntermediaria {\n" +
    ...
    public enum TipoRecebedorEnum {
        ...
        TRANSPORTADOR_TERRESTRE("TRANSPORTADOR_TERRESTRE"),

        @XmlEnumValue("OPERADOR_REMESSA_POSTAL")
        @JsonProperty("OPERADOR_REMESSA_POSTAL")
        OPERADOR_REMESSA_POSTAL("OPERADOR_REMESSA_POSTAL");
