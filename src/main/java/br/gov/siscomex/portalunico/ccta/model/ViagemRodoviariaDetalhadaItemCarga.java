...
@XmlType(name = "ViagemRodoviariaDetalhadaItemCarga", propOrder =
        {"chassi", "conteinerVazio", "contramarca", "descricao", "embalagemVazia", "lacresConteiner", "marca", "medidaConteiner", "numeroConteiner", "pesoBruto", "quantidadeVolumes", "sequencial", "taraConteiner", "tipoEmbalagem", "tipoGranel"
        })
