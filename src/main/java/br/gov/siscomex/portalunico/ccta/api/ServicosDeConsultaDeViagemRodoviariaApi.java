...
import br.gov.siscomex.portalunico.ccta.model.ViagemRodoviariaDetalhada;
import br.gov.siscomex.portalunico.ccta.model.ViagemRodoviariaResumidaCargasDetalhadas;
...
public interface ServicosDeConsultaDeViagemRodoviariaApi {
     ...
     */
    @GET
    @Path("/api/ext/rodoviario/viagens/detalhe/cargas")
     ...
     */
    @GET
    @Path("/api/ext/rodoviario/viagens/detalhe")
    @Produces({"application/json"})
