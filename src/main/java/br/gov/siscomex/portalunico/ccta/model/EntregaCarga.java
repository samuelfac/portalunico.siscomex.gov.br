...
@XmlType(name = "EntregaCarga", propOrder =
        {"cnpjResponsavelArquivo", "cnpjResponsavelEntrega", "comprovanteIcmsApresentado", "contingencia", "dataEmissao", "dataHoraEntrega", "documentosTransporte", "identificacaoCarga", "numeroDocumentoSaida", "observacoes", "pesoEntrega", "recebedor", "recintoAduaneiro", "tipoCarga", "tipoDocumentoSaida", "tipoEntrega", "unidadeRFB", "volumeEntrega"
        })
...
public class EntregaCarga {
    ...
    @ApiModelProperty(example = "2020-08-07", value = "Data da emissão do conhecimento.<br/>Obrigatório para tipos de conhecimento AWB, MAWB, HAWB (conhecimentos do aéreo) e CRT (Conhecimento Rodoviário de Trânsito).<br/>Para o tipo DSIC não deve ser informado.<br/>Formato: yyyy-MM-dd<br/>Formato: yyyy-MM-dd")
    /**
     * Data da emissão do conhecimento.<br/>Obrigatório para tipos de conhecimento AWB, MAWB, HAWB (conhecimentos do aéreo) e CRT (Conhecimento Rodoviário de Trânsito).<br/>Para o tipo DSIC não deve ser informado.<br/>Formato: yyyy-MM-dd<br/>Formato: yyyy-MM-dd
     **/
    ...
    @ApiModelProperty(value = "Lista de identificação MIC/DTA - Manifesto Internacional de Carga / Declaração de Trânsito Aduaneiro.")
    @Valid
    /**
     * Lista de identificação MIC/DTA - Manifesto Internacional de Carga / Declaração de Trânsito Aduaneiro.
     **/
    private List<DocumentoTransporteRepresentation> documentosTransporte = null;

    @XmlElement(name = "identificacaoCarga", required = true)
    @ApiModelProperty(example = "43NQKMM8KNT", required = true, value = "Identificação da carga (AWB/MAWB/HAWB/DSIC/CRT)<br/>Tamanho mínimo: 1<br/>Tamanho máximo: 35")
    /**
    ...
    @ApiModelProperty(example = "740", required = true, value = "Tipo de carga. <p>Os tipos podem ser:</p><ul><li><em>740</em> – Air Waybill.</li><li><em>741</em> – Master Air Waybill.</li><li><em>703</em> – House Air Waybill.</li><li><em>14</em> – DSIC - Documento Subsidiário de Identificação de Carga.</li><li><em>13</em> – CRT - Conhecimento Rodoviário de Trânsito.</li></ul>")
    /**
    ...
    @ApiModelProperty(example = "PROCESSO", required = true, value = "Tipo de documento de saída. O CRT não pode ser vinculado ao documento de saída DI (vinculação automática).")
    /**
    ...
    @NotNull
    public Boolean isisComprovanteIcmsApresentado() {
        return comprovanteIcmsApresentado;
    }
    ...
    public List<DocumentoTransporteRepresentation> getDocumentosTransporte() {
        return documentosTransporte;
    }

    public void setDocumentosTransporte(List<DocumentoTransporteRepresentation> documentosTransporte) {
        this.documentosTransporte = documentosTransporte;
    }

    public EntregaCarga documentosTransporte(List<DocumentoTransporteRepresentation> documentosTransporte) {
        this.documentosTransporte = documentosTransporte;
        return this;
    }

    public EntregaCarga addDocumentosTransporteItem(DocumentoTransporteRepresentation documentosTransporteItem) {
