...
@XmlType(name = "EntregaCarga", propOrder =
        {"pesoEntrega", "comprovanteIcmsApresentado", "tipoCarga", "dataHoraEntrega", "recebedor", "tipoEntrega", "dataEmissao", "observacoes", "cnpjResponsavelArquivo", "cnpjResponsavelEntrega", "volumeEntrega", "identificacaoCarga", "documentosTransporte", "numeroDocumentoSaida", "tipoDocumentoSaida", "recintoAduaneiro", "unidadeRFB", "contingencia"
        })
