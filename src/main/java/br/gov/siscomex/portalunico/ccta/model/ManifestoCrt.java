...
@XmlType(name = "ManifestoCrt", propOrder =
        {"licencaComplementarTransportador", "codigoPostalRemetente", "estadoDestinatario", "valorSeguroRemetente", "moedaMercadoriaLocalEmbarque", "moedaOutrosCustosRemetente", "documentosApresentados", "localAssinaturaRemetente", "moedaFreteExterno", "cidadeRemetente", "valorFreteRemetente", "transportadoresSucessivos", "localAssinaturaDestinatario", "tipoDocIdFiscalConsignatario", "cidadeTranspResponsMercadoria", "moedaMercadoriaDeclaradoRemetente", "moedaSeguroRemetente", "estadoConsignatario", "idFiscalParteNotificar", "paisEntrega", "ruaParteNotificarEstrangeiro", "nomeDestinatario", "telefoneParteNotificar", "tipoDocIdFiscalParteNotificar", "valorFreteExterno", "codigoPostalParteNotificarEstrangeiro", "cidadeEmissao", "cidadeDestinatario", "moedaOutrosCustosDestinatario", "bairroDestinatario", "dataEmissao", "codigoPostalConsignatario", "tipoItemCRT", "dataHoraAssinaturaRemetente", "nomeParteNotificarEstrangeiro", "paisEmissao", "identificacaoTransportadorEstrangeiro", "nomeConsignatario", "valorReembolso", "incotermLocalEmbarque", "ruaConsignatario", "nomeRemetente", "nomeTransportadorEstrangeiro", "cidadeEntrega", "paisOrigemMercadoria", "ruaRemetente", "cidadeParteNotificarEstrangeiro", "valorMercadoriaLocalEmbarque", "mercadorias", "pesoBrutoKg", "identificacaoTransportadorNacional", "paisTranspResponsMercadoria", "estadoParteNotificarEstrangeiro", "tipoTransporteTransportador", "declaracaoObservacao", "valorFreteDestinatario", "ruc", "emailParteNotificar", "moedaFreteRemetente", "visualizacaoDepositario", "transportadorNacBrasileira", "valorSeguroDestinatario", "valorOutrosCustosRemetente", "estadoRemetente", "bairroParteNotificarEstrangeiro", "idFiscalConsignatario", "bairroConsignatario", "identificacaoRepresentanteTransportadorEstrangeiro", "valorOutrosCustosDestinatario", "nomeAssinaturaRemetente", "paisRemetente", "volumeM3", "moedaSeguroDestinatario", "destinatarioNacBrasileira", "moedaFreteDestinatario", "licencaOriginariaTransportador", "dataHoraTranspResponsMercadoria", "itensCRT", "idFiscalDestinatario", "paisConsignatario", "cidadeConsignatario", "paisDestinatario", "valorMercadoriaDeclaradoRemetente", "paisParteNotificarEstrangeiro", "codigoPostalDestinatario", "dataHoraAssinaturaDestinatario", "inParteNotificarNacBrasileira", "identificacaoCrt", "idFiscalRemetente", "ruaDestinatario", "inConsignatarioNacBrasileira", "moedaReembolso", "instrucaoFormalidadeAlfandega", "manuseiosEspeciaisCarga", "nomeAssinaturaTransportador", "bairroRemetente", "prazoEntrega", "nomeAssinaturaDestinatario"
        })
