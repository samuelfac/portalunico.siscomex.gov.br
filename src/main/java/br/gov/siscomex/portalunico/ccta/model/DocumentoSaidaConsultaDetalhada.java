...
@XmlType(name = "DocumentoSaidaConsultaDetalhada", propOrder =
        {"canalDuimp", "dataConclusaoDta", "dataHoraVinculacao", "numero", "raDestinoDta", "situacaoDuimp", "tipo", "uaDestinoDta", "versaoDuimp"
        })
...
public class DocumentoSaidaConsultaDetalhada {
    ...
    @ApiModelProperty(value = "Tipo de canal em que caiu a Duimp")
    /**
    ...
    @ApiModelProperty(value = "Descrião da situação Duimp")
    /**
     * Descrião da situação Duimp
     **/
