...
public enum TipoOperacaoEnum {
  ...
  @ApiModelProperty(example = "DI", required = true, value = "DI - Declaração de Importação,<br/>LI - Licença de Importação,<br/>RE - Registro de Exportação,<br/>DT - Declaração de Trânsito,<br/>DIR - Declaração de Importação de Remessa<br>")
 /**
   * DI - Declaração de Importação,<br/>LI - Licença de Importação,<br/>RE - Registro de Exportação,<br/>DT - Declaração de Trânsito,<br/>DIR - Declaração de Importação de Remessa<br>
  **/
