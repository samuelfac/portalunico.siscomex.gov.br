...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "CodigoNomePaisDTO", propOrder =
    { "codigo", "nome"
})

@XmlRootElement(name="CodigoNomePaisDTO")
/**
  * Código e nome de um País.
 **/
@ApiModel(description="Código e nome de um País.")
public class CodigoNomePaisDTO  {
  ...
  **/
  ...
  public CodigoNomePaisDTO codigo(String codigo) {
    this.codigo = codigo;
    return this;
  }
  ...
  **/
  ...
  public CodigoNomePaisDTO nome(String nome) {
    this.nome = nome;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class CodigoNomePaisDTO {\n");
