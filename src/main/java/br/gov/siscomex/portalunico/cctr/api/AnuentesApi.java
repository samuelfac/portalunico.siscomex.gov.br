...
import br.gov.siscomex.portalunico.cctr.model.InfoCargaTransitoDTO;
...
public interface AnuentesApi {
     ...
     *
     * &lt;p&gt;&lt;a rel&#x3D;\&quot;noopener noreferrer\&quot; target&#x3D;\&quot;_blank\&quot; href&#x3D;\&quot;../../pages/exemplos/cctr/secex-p025/\&quot;&gt;Exemplos de Respostas&lt;/a&gt;&lt;/p&gt;
     *
     */
    @GET
    @Path("/ext/anuentes/{due}")
    @Produces({"application/json"})
    @ApiOperation(value = "Obter Dados da Carga e Trânsito a partir do número da DU-E", notes = "<p><a rel=\"noopener noreferrer\" target=\"_blank\" href=\"../../pages/exemplos/cctr/secex-p025/\">Exemplos de Respostas</a></p>", tags = {"Anuentes"})
    @ApiResponses(value = {
