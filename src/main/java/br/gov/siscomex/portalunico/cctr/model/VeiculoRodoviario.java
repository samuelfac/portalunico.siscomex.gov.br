...
public class VeiculoRodoviario {
    ...
    /**
     * CPF do proprietário do veículo<br>Informado quando o Transportador não for o proprietário<br>Tamanho: 11<br>Formato: NNNNNNNNNNN
     **/
    ...
    public VeiculoRodoviario cpfProprietario(String cpfProprietario) {
        this.cpfProprietario = cpfProprietario;
        return this;
    }
