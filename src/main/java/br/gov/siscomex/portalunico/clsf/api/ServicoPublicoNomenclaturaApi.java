package br.gov.siscomex.portalunico.clsf.api;
...
public interface ServicoPublicoNomenclaturaApi {
    ...
    @ApiOperation(value = "Download do Arquivo ", notes = "", tags = {"Servico Publico Nomenclatura"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "sucesso"),
            @ApiResponse(code = 404, message = "Arquivo não encontrado")})
    void downloadPublico();
}
