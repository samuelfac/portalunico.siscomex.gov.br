...
public class ExigenciaFiscalDTO {
    ...
    public enum SituacaoEnum {
        ...
        ENCERRADA_POR_OFICIO("ENCERRADA_POR_OFICIO"),
        ...
        CANCELADA_DUIMP("CANCELADA_DUIMP"),
    ...
    public String toString() {
        ...
        String sb = "class ExigenciaFiscalDTO {\n" +
