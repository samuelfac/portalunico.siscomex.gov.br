...
public class DUE {
    ...
    public enum SituacaoEnum {
        ...
        CANCELADA_PELA_ADUANA_A_PEDIDO_DO_EXPORTADOR("CANCELADA_PELA_ADUANA_A_PEDIDO_DO_EXPORTADOR"),
