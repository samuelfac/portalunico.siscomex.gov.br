...
@XmlType(name = "ItemCrt", propOrder =
        {"conteinerVazio", "contemPartesMadeira", "contramarca", "descricao", "marca", "medidaConteiner", "numeroChassiVeiculo", "numeroConteiner", "pesoBrutoKg", "pesoLiquido", "qtdeVolumesTotalManifestada", "sequencial", "taraConteiner", "tipoEmbalagem", "tipoGranel"
        })
...
public class ItemCrt {
    ...
    @XmlElement(name = "contemPartesMadeira", required = true)
    @ApiModelProperty(required = true, value = "Indica se o item de carga contem partes em madeira")
    /**
     * Indica se o item de carga contem partes em madeira
     **/
    private Boolean contemPartesMadeira = null;
    ...
    public Boolean isConteinerVazio() {
        return conteinerVazio;
    }
     ...
     * Indica se o item de carga contem partes em madeira
     *
     * @return contemPartesMadeira
     **/
    @JsonProperty("contemPartesMadeira")
    @NotNull
    public Boolean isContemPartesMadeira() {
        return contemPartesMadeira;
    }

    public void setContemPartesMadeira(Boolean contemPartesMadeira) {
        this.contemPartesMadeira = contemPartesMadeira;
    }

    public ItemCrt contemPartesMadeira(Boolean contemPartesMadeira) {
        this.contemPartesMadeira = contemPartesMadeira;
        return this;
    }
