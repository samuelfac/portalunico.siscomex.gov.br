...
public class ManifestoViagem {
    ...
    @XmlElement(name = "itensEnLastre")
    @ApiModelProperty(value = "")
    @Valid
    private List<ItemEnLastre> itensEnLastre = null;
    ...
    @ApiModelProperty(example = "123424", value = "Licença complementar<br/>campo obrigatório  se tipoTransporte é REG e transportadorNacBrasileira é false.<br/> Tamanho Máximo: 6")
    /**
    ...
    @ApiModelProperty(example = "123424", value = "Licença originária<br/>campo obrigatório  se tipoTransporte é REG e transportadorNacBrasileira é true.<br/> Tamanho Máximo: 6")
    /**
    ...
    @ApiModelProperty(example = "15656489854988", value = "Numero da declaração de trânsito no exterior, quando ocorrer<br/> Tamanho Máximo: 20")
    /**
    ...
    @XmlElement(name = "temPecasMadeira", required = true)
    @ApiModelProperty(example = "true", required = true, value = "indicador se o veículo está transportando cargas com partes ou peças de madeira ")
    /**
     * indicador se o veículo está transportando cargas com partes ou peças de madeira
     **/
    private Boolean temPecasMadeira = null;
    ...
    @ApiModelProperty(example = "true", required = true, value = "Indicador que informe se é trânsito aduaneiro internacional, ou seja, se haverá desembaraço na fronteira (false) ou seguirá por trânsito (true)")
    /**
    ...
    @NotNull
    public Boolean isCavaloPropriaMercadoria() {
        return cavaloPropriaMercadoria;
    }
    ...
    @NotNull
    public Boolean isCondutorBrasileiro() {
        return condutorBrasileiro;
    }
     ...
     * Get itensEnLastre
     *
     * @return itensEnLastre
     **/
    @JsonProperty("itensEnLastre")
    public List<ItemEnLastre> getItensEnLastre() {
        return itensEnLastre;
    }

    public void setItensEnLastre(List<ItemEnLastre> itensEnLastre) {
        this.itensEnLastre = itensEnLastre;
    }

    public ManifestoViagem itensEnLastre(List<ItemEnLastre> itensEnLastre) {
        this.itensEnLastre = itensEnLastre;
        return this;
    }

    public ManifestoViagem addItensEnLastreItem(ItemEnLastre itensEnLastreItem) {
        this.itensEnLastre.add(itensEnLastreItem);
        return this;
    }
    ...
    public ManifestoViagem licencaComplementar(String licencaComplementar) {
        this.licencaComplementar = licencaComplementar;
        return this;
    }
    ...
    public ManifestoViagem licencaOriginaria(String licencaOriginaria) {
        this.licencaOriginaria = licencaOriginaria;
        return this;
    }
    ...
    @NotNull
    public Boolean isProprietarioVeiculoBrasileiro() {
        return proprietarioVeiculoBrasileiro;
    }
    ...
    @NotNull
    public Boolean isTemPecasMadeira() {
        return temPecasMadeira;
    }

    public void setTemPecasMadeira(Boolean temPecasMadeira) {
        this.temPecasMadeira = temPecasMadeira;
    }

    public ManifestoViagem temPecasMadeira(Boolean temPecasMadeira) {
        this.temPecasMadeira = temPecasMadeira;
        return this;
    }
    ...
    @NotNull
    public Boolean isTransitoInternacional() {
        return transitoInternacional;
    }
    ...
    @NotNull
    public Boolean isTransportadorImportador() {
        return transportadorImportador;
    }
    ...
    @NotNull
    public Boolean isTransportadorNacBrasileira() {
        return transportadorNacBrasileira;
    }
    ...
    @NotNull
    public Boolean isTransportadorProprietarioVeiculo() {
        return transportadorProprietarioVeiculo;
    }
