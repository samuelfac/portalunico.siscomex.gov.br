...
public class ManifestoCrt {
    ...
    @ApiModelProperty(example = "3", required = true, value = "Identifica qual o tipo de Carga<br/>Granel (3), Veículo (4), Carga Solta (2), Conteiner (1)")
    /**
    ...
    @NotNull
    public Boolean isDestinatarioNacBrasileira() {
        return destinatarioNacBrasileira;
    }
    ...
    public Boolean isInConsignatarioNacBrasileira() {
        return inConsignatarioNacBrasileira;
    }
    ...
    public Boolean isInParteNotificarNacBrasileira() {
        return inParteNotificarNacBrasileira;
    }
