...
import br.gov.siscomex.portalunico.cct_imp.model.OperacaoDesunitizacao;
...
public interface OperaesDeContinerApi {

    /**
     * Desunitizar Contêiner
     *
     */
    @POST
    @Path("/api/ext/imp/conteiner/desunitizar")
    @Consumes({"application/xml"})
    @Produces({"application/xml"})
    @ApiOperation(value = "Desunitizar Contêiner", notes = "", tags = {"Operações de Contêiner"})
    @ApiResponses(value = {
    ...
    Response desunitizar(@ApiParam(value = "Dados da desunitização", required = true) @Valid OperacaoDesunitizacao body);
}
