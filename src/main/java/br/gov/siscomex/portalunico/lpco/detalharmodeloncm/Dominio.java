...
public class Dominio {
    ...
    public String toString() {
        ...
        sb.append(Dominio.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Dominio) == false) {
            return false;
        }
        Dominio rhs = ((Dominio) other);
