...
public class ValoresTributoDuimpCover  {
  ...
  **/
  ...
  @ApiModelProperty(example = "201.12", value = "Valor Devido do Tributo em R$ (Reais).<br>Tamanho: 16,7<br>Formato: Decimal, com até 7 casas decimais separadas por ponto.")
 /**
