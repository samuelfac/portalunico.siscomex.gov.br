 ...
 **/
@ApiModel(description = "Retorno do download do documento.")
public class RetornoDownloadDocumento {

    @XmlElement(name = "arquivoZipBase64", required = true)
    @ApiModelProperty(example = "UEsDBBQACAAIAEN2Qk8AAAAAAAAAAFULAAANACAAenp6enou ..... AAEEKIyVGgR4AwAAUEsFBgAAAAACAAIAsgAAAAIJAAAAAA==", required = true, value = "String em BASE64 representando o conteúdo do arquivo no formato zip<br/>Tamanho máximo do arquivo original: equivalente a 15MB, aproximadamente 20MB em BASE64")
    /**
    ...
    public String toString() {
        ...
        String sb = "class RetornoDownloadDocumento {\n" +
