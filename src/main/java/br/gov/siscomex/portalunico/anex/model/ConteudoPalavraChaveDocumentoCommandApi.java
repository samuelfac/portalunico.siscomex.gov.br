...
@XmlType(name = "ConteudoPalavraChaveDocumentoCommandApi", propOrder =
        {"conteudo", "idPalavraChave"
        })

@XmlRootElement(name = "ConteudoPalavraChaveDocumentoCommandApi")
/**
 * Conteúdo da palavra-chave.
 **/
@ApiModel(description = "Conteúdo da palavra-chave.")
public class ConteudoPalavraChaveDocumentoCommandApi {
    ...
    public ConteudoPalavraChaveDocumentoCommandApi conteudo(String conteudo) {
        this.conteudo = conteudo;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class ConteudoPalavraChaveDocumentoCommandApi {\n" +
