...
@XmlType(name = "PalavraChave", propOrder =
        {"obrigatoria", "tamanhoCampo", "dominios", "casasDecimais", "idPalavraChave", "nomePalavraChave", "mascara", "tipoDado"
        })
...
public class PalavraChave {
     ...
     **/
    private Boolean obrigatoria = null;
     ...
     **/
    private Long idPalavraChave = null;
    ...
    @NotNull
    public Boolean isisObrigatoria() {
        return obrigatoria;
    }
    ...
    public PalavraChave idPalavraChave(Long idPalavraChave) {
        this.idPalavraChave = idPalavraChave;
        return this;
    }
