...
@XmlType(name = "GuiaIcmsCreditoDto", propOrder =
        {"dataPagamento", "valorCalculado", "codigoBarrasGuia", "codigoReceita", "dataLimitePagamento", "geradorGuia", "valorJuros", "descricaoCodigoReceita", "valorAtualizacaoMonetaria", "valorDevido", "dataVencimento", "linhaDigitavel", "valorTotal", "numeroControle", "valorMulta"
        })
