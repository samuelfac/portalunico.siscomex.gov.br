...
@XmlType(name = "ManifestoDoProcessamentoDoPedidoDeReviso", propOrder =
        {"numeroManifesto", "remessas"
        })

@XmlRootElement(name = "ManifestoDoProcessamentoDoPedidoDeReviso")
public class ManifestoDoProcessamentoDoPedidoDeReviso {
     ...
     * Lista de remessas.
     **/
    private List<RemessaDoProcessamentoDoPedidoDeReviso> remessas = new ArrayList<>();
    ...
    public ManifestoDoProcessamentoDoPedidoDeReviso numeroManifesto(String numeroManifesto) {
        this.numeroManifesto = numeroManifesto;
        return this;
    }
    ...
    @NotNull
    public List<RemessaDoProcessamentoDoPedidoDeReviso> getRemessas() {
        return remessas;
    }

    public void setRemessas(List<RemessaDoProcessamentoDoPedidoDeReviso> remessas) {
        this.remessas = remessas;
    }

    public ManifestoDoProcessamentoDoPedidoDeReviso remessas(List<RemessaDoProcessamentoDoPedidoDeReviso> remessas) {
        this.remessas = remessas;
        return this;
    }

    public ManifestoDoProcessamentoDoPedidoDeReviso addRemessasItem(RemessaDoProcessamentoDoPedidoDeReviso remessasItem) {
    ...
    public String toString() {
        ...
        String sb = "class ManifestoDoProcessamentoDoPedidoDeReviso {\n" +
