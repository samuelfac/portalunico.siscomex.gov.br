...
@XmlType(name = "ManifestoDaConsultaDeManifestosPelaRFB", propOrder =
        {"qtdRemessasSelecionadas", "numeroManifesto", "listaNumeroRemessa", "uaDespacho", "dataHorarioRegistroManifesto", "operadora", "qtdRemessas"
        })

@XmlRootElement(name = "ManifestoDaConsultaDeManifestosPelaRFB")
public class ManifestoDaConsultaDeManifestosPelaRFB {
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB qtdRemessasSelecionadas(Integer qtdRemessasSelecionadas) {
        this.qtdRemessasSelecionadas = qtdRemessasSelecionadas;
        return this;
    }
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB numeroManifesto(String numeroManifesto) {
        this.numeroManifesto = numeroManifesto;
        return this;
    }
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB listaNumeroRemessa(List<String> listaNumeroRemessa) {
        this.listaNumeroRemessa = listaNumeroRemessa;
        return this;
    }

    public ManifestoDaConsultaDeManifestosPelaRFB addListaNumeroRemessaItem(String listaNumeroRemessaItem) {
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB uaDespacho(String uaDespacho) {
        this.uaDespacho = uaDespacho;
        return this;
    }
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB dataHorarioRegistroManifesto(OffsetDateTime dataHorarioRegistroManifesto) {
        this.dataHorarioRegistroManifesto = dataHorarioRegistroManifesto;
        return this;
    }
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB operadora(String operadora) {
        this.operadora = operadora;
        return this;
    }
    ...
    public ManifestoDaConsultaDeManifestosPelaRFB qtdRemessas(Integer qtdRemessas) {
        this.qtdRemessas = qtdRemessas;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class ManifestoDaConsultaDeManifestosPelaRFB {\n" +
