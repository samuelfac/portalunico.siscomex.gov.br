...
@XmlType(name = "ManifestoDaSolicitaoDarf", propOrder =
        {"numeroManifesto", "remessas"
        })

@XmlRootElement(name = "ManifestoDaSolicitaoDarf")
public class ManifestoDaSolicitaoDarf {
     ...
     * Lista de remessas.
     **/
    private List<RemessaDaSolicitaoDarf> remessas = new ArrayList<>();
    ...
    public ManifestoDaSolicitaoDarf numeroManifesto(String numeroManifesto) {
        this.numeroManifesto = numeroManifesto;
        return this;
    }
    ...
    @NotNull
    public List<RemessaDaSolicitaoDarf> getRemessas() {
        return remessas;
    }

    public void setRemessas(List<RemessaDaSolicitaoDarf> remessas) {
        this.remessas = remessas;
    }

    public ManifestoDaSolicitaoDarf remessas(List<RemessaDaSolicitaoDarf> remessas) {
        this.remessas = remessas;
        return this;
    }

    public ManifestoDaSolicitaoDarf addRemessasItem(RemessaDaSolicitaoDarf remessasItem) {
    ...
    public String toString() {
        ...
        String sb = "class ManifestoDaSolicitaoDarf {\n" +
