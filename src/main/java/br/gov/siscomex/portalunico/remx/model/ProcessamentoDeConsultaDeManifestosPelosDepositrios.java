...
public class ProcessamentoDeConsultaDeManifestosPelosDepositrios {
    ...
    public ProcessamentoDeConsultaDeManifestosPelosDepositrios dataHoraProcessamento(OffsetDateTime dataHoraProcessamento) {
        this.dataHoraProcessamento = dataHoraProcessamento;
        return this;
    }
    ...
    public ProcessamentoDeConsultaDeManifestosPelosDepositrios dataHorarioEnvio(OffsetDateTime dataHorarioEnvio) {
        this.dataHorarioEnvio = dataHorarioEnvio;
        return this;
    }
    ...
    public ProcessamentoDeConsultaDeManifestosPelosDepositrios erros(List<ErroNoProcessamento> erros) {
        this.erros = erros;
        return this;
    }

    public ProcessamentoDeConsultaDeManifestosPelosDepositrios addErrosItem(ErroNoProcessamento errosItem) {
