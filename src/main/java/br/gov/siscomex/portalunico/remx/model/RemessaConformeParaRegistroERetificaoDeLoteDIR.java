...
public class RemessaConformeParaRegistroERetificaoDeLoteDIR {
    ...
    public RemessaConformeParaRegistroERetificaoDeLoteDIR codigoOND(String codigoOND) {
        this.codigoOND = codigoOND;
        return this;
    }
    ...
    public RemessaConformeParaRegistroERetificaoDeLoteDIR nomeECE(String nomeECE) {
        this.nomeECE = nomeECE;
        return this;
    }
    ...
    public RemessaConformeParaRegistroERetificaoDeLoteDIR nomeOND(String nomeOND) {
        this.nomeOND = nomeOND;
        return this;
    }
    ...
    public RemessaConformeParaRegistroERetificaoDeLoteDIR valorProvICMS(BigDecimal valorProvICMS) {
        this.valorProvICMS = valorProvICMS;
        return this;
    }
