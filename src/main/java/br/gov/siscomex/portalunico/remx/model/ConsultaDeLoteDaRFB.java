...
public class ConsultaDeLoteDaRFB {
    ...
    public ConsultaDeLoteDaRFB dataFimLote(OffsetDateTime dataFimLote) {
        this.dataFimLote = dataFimLote;
        return this;
    }
    ...
    public ConsultaDeLoteDaRFB dataFimManifesto(OffsetDateTime dataFimManifesto) {
        this.dataFimManifesto = dataFimManifesto;
        return this;
    }
    ...
    public ConsultaDeLoteDaRFB dataInicioOcorrencia(OffsetDateTime dataInicioOcorrencia) {
        this.dataInicioOcorrencia = dataInicioOcorrencia;
        return this;
    }
    ...
    public ConsultaDeLoteDaRFB listaOperadora(List<String> listaOperadora) {
        this.listaOperadora = listaOperadora;
        return this;
    }

    public ConsultaDeLoteDaRFB addListaOperadoraItem(String listaOperadoraItem) {
    ...
    public ConsultaDeLoteDaRFB listaOrgaoFiscalizacao(List<String> listaOrgaoFiscalizacao) {
        this.listaOrgaoFiscalizacao = listaOrgaoFiscalizacao;
        return this;
    }

    public ConsultaDeLoteDaRFB addListaOrgaoFiscalizacaoItem(String listaOrgaoFiscalizacaoItem) {
