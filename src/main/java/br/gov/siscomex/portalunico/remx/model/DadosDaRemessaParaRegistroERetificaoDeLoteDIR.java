...
@XmlType(name = "DadosDaRemessaParaRegistroERetificaoDeLoteDIR", propOrder =
        {"destinacaoComercial", "remetente", "numeroRemessa", "peso", "moedaFrete", "volumes", "infoFiscalizacao", "descricao", "destinatario", "remessaConforme", "infoCompl", "freteModoPagto", "numeroMaster", "mercadorias", "frete"
        })
