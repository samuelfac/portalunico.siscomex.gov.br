...
@XmlType(name = "RetornoDeErro", propOrder =
        {"code", "date", "detail", "field", "info", "message", "path", "severity", "tag"
        })

@XmlRootElement(name = "RetornoDeErro")
public class RetornoDeErro {
    ...
    public RetornoDeErro code(String code) {
        this.code = code;
        return this;
    }
    ...
    public RetornoDeErro date(String date) {
        this.date = date;
        return this;
    }
    ...
    public RetornoDeErro detail(List<IExceptionCover> detail) {
        this.detail = detail;
        return this;
    }

    public RetornoDeErro addDetailItem(IExceptionCover detailItem) {
    ...
    public RetornoDeErro field(String field) {
        this.field = field;
        return this;
    }
    ...
    public RetornoDeErro info(DiagnosticInfo info) {
        this.info = info;
        return this;
    }
    ...
    public RetornoDeErro message(String message) {
        this.message = message;
        return this;
    }
    ...
    public RetornoDeErro path(String path) {
        this.path = path;
        return this;
    }
    ...
    public RetornoDeErro severity(SeverityEnum severity) {
        this.severity = severity;
        return this;
    }
    ...
    public RetornoDeErro tag(String tag) {
        this.tag = tag;
        return this;
    }
