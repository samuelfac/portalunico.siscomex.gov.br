...
@XmlType(name = "RemessaDoProcessamentoDaSolicitaoDeDevoluo", propOrder =
        {"numeroRemessa", "numeroLote", "novaSituacaoRemessa"
        })

@XmlRootElement(name = "RemessaDoProcessamentoDaSolicitaoDeDevoluo")
public class RemessaDoProcessamentoDaSolicitaoDeDevoluo {
    ...
    public RemessaDoProcessamentoDaSolicitaoDeDevoluo numeroRemessa(String numeroRemessa) {
        this.numeroRemessa = numeroRemessa;
        return this;
    }
    ...
    public RemessaDoProcessamentoDaSolicitaoDeDevoluo numeroLote(String numeroLote) {
        this.numeroLote = numeroLote;
        return this;
    }
    ...
    public RemessaDoProcessamentoDaSolicitaoDeDevoluo novaSituacaoRemessa(Integer novaSituacaoRemessa) {
        this.novaSituacaoRemessa = novaSituacaoRemessa;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class RemessaDoProcessamentoDaSolicitaoDeDevoluo {\n" +
