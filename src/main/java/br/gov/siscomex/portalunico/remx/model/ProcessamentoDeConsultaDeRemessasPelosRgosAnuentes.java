...
@XmlType(name = "ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes", propOrder =
        {"dataHoraProcessamento", "dataHorarioEnvio", "erros", "manifestos", "numeroProtocolo", "situacao"
        })

@XmlRootElement(name = "ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes")
public class ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes {
    ...
    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes dataHoraProcessamento(OffsetDateTime dataHoraProcessamento) {
        this.dataHoraProcessamento = dataHoraProcessamento;
        return this;
    }
    ...
    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes dataHorarioEnvio(OffsetDateTime dataHorarioEnvio) {
        this.dataHorarioEnvio = dataHorarioEnvio;
        return this;
    }
    ...
    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes erros(List<ErroNoProcessamento> erros) {
        this.erros = erros;
        return this;
    }

    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes addErrosItem(ErroNoProcessamento errosItem) {
    ...
    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes manifestos(List<DetalheDoProcessamentoDoManifesto> manifestos) {
        this.manifestos = manifestos;
        return this;
    }

    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes addManifestosItem(DetalheDoProcessamentoDoManifesto manifestosItem) {
    ...
    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes numeroProtocolo(String numeroProtocolo) {
        this.numeroProtocolo = numeroProtocolo;
        return this;
    }
    ...
    public ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes situacao(Integer situacao) {
        this.situacao = situacao;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class ProcessamentoDeConsultaDeRemessasPelosRgosAnuentes {\n" +
