...
@XmlType(name = "EndereoParaRegistroERetificaoDeManifesto", propOrder =
        {"estado", "complemento", "logradouro", "municipio", "cep", "pais"
        })

@XmlRootElement(name = "EndereoParaRegistroERetificaoDeManifesto")
public class EndereoParaRegistroERetificaoDeManifesto {
    ...
    public EndereoParaRegistroERetificaoDeManifesto estado(String estado) {
        this.estado = estado;
        return this;
    }
    ...
    public EndereoParaRegistroERetificaoDeManifesto complemento(String complemento) {
        this.complemento = complemento;
        return this;
    }
    ...
    public EndereoParaRegistroERetificaoDeManifesto logradouro(String logradouro) {
        this.logradouro = logradouro;
        return this;
    }
    ...
    public EndereoParaRegistroERetificaoDeManifesto municipio(Integer municipio) {
        this.municipio = municipio;
        return this;
    }
    ...
    public EndereoParaRegistroERetificaoDeManifesto cep(String cep) {
        this.cep = cep;
        return this;
    }
    ...
    public EndereoParaRegistroERetificaoDeManifesto pais(Integer pais) {
        this.pais = pais;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class EndereoParaRegistroERetificaoDeManifesto {\n" +
