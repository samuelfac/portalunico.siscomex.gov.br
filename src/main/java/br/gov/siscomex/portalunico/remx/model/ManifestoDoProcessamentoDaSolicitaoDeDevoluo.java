...
@XmlType(name = "ManifestoDoProcessamentoDaSolicitaoDeDevoluo", propOrder =
        {"numeroManifesto", "remessas"
        })

@XmlRootElement(name = "ManifestoDoProcessamentoDaSolicitaoDeDevoluo")
public class ManifestoDoProcessamentoDaSolicitaoDeDevoluo {
     ...
     * Lista de remessas.
     **/
    private List<RemessaDoProcessamentoDaSolicitaoDeDevoluo> remessas = new ArrayList<>();
    ...
    public ManifestoDoProcessamentoDaSolicitaoDeDevoluo numeroManifesto(String numeroManifesto) {
        this.numeroManifesto = numeroManifesto;
        return this;
    }
    ...
    @NotNull
    public List<RemessaDoProcessamentoDaSolicitaoDeDevoluo> getRemessas() {
        return remessas;
    }

    public void setRemessas(List<RemessaDoProcessamentoDaSolicitaoDeDevoluo> remessas) {
        this.remessas = remessas;
    }

    public ManifestoDoProcessamentoDaSolicitaoDeDevoluo remessas(List<RemessaDoProcessamentoDaSolicitaoDeDevoluo> remessas) {
        this.remessas = remessas;
        return this;
    }

    public ManifestoDoProcessamentoDaSolicitaoDeDevoluo addRemessasItem(RemessaDoProcessamentoDaSolicitaoDeDevoluo remessasItem) {
    ...
    public String toString() {
        ...
        String sb = "class ManifestoDoProcessamentoDaSolicitaoDeDevoluo {\n" +
