...
public class PessoaParaRegistroERetificaoDeLoteDIR {
    ...
    public PessoaParaRegistroERetificaoDeLoteDIR conta(String conta) {
        this.conta = conta;
        return this;
    }
    ...
    public PessoaParaRegistroERetificaoDeLoteDIR documento(String documento) {
        this.documento = documento;
        return this;
    }
    ...
    public PessoaParaRegistroERetificaoDeLoteDIR nome(String nome) {
        this.nome = nome;
        return this;
    }
