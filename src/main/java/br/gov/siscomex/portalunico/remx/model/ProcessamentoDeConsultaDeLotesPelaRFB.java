...
public class ProcessamentoDeConsultaDeLotesPelaRFB {
    ...
    public ProcessamentoDeConsultaDeLotesPelaRFB dataHoraProcessamento(OffsetDateTime dataHoraProcessamento) {
        this.dataHoraProcessamento = dataHoraProcessamento;
        return this;
    }
    ...
    public ProcessamentoDeConsultaDeLotesPelaRFB dataHorarioEnvio(OffsetDateTime dataHorarioEnvio) {
        this.dataHorarioEnvio = dataHorarioEnvio;
        return this;
    }
     ...
     **/
    @JsonProperty("lotes")
    public List<LoteDaConsultaDeLotesPelaRFB> getLotes() {
        return lotes;
    }

    public void setLotes(List<LoteDaConsultaDeLotesPelaRFB> lotes) {
        this.lotes = lotes;
    }

    public ProcessamentoDeConsultaDeLotesPelaRFB lotes(List<LoteDaConsultaDeLotesPelaRFB> lotes) {
        this.lotes = lotes;
        return this;
    }

    public ProcessamentoDeConsultaDeLotesPelaRFB addLotesItem(LoteDaConsultaDeLotesPelaRFB lotesItem) {
