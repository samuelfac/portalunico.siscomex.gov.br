...
@XmlType(name = "OperadorEstrangeiroIntegracaoDTO", propOrder =
        {"codigo", "situacao", "codigoInterno", "nomeCidade", "nome", "identificacoesAdicionais", "codigoPais", "cep", "cpfCnpjRaiz", "dataReferencia", "codigoSubdivisaoPais", "logradouro", "tin", "seq", "versao", "email"
        })
...
public class OperadorEstrangeiroIntegracaoDTO {
    ...
    public String toString() {
        ...
        String sb = "class OperadorEstrangeiroIntegracaoDTO {\n" +
