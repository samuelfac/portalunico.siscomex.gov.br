...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "ProdutoCampoIntegracaoDTO", propOrder =
    { "atributo", "valor"
})

@XmlRootElement(name="ProdutoCampoIntegracaoDTO")
public class ProdutoCampoIntegracaoDTO  {
  ...
  **/
  ...
  public ProdutoCampoIntegracaoDTO atributo(String atributo) {
    this.atributo = atributo;
    return this;
  }
  ...
  **/
  ...
  public ProdutoCampoIntegracaoDTO valor(String valor) {
    this.valor = valor;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ProdutoCampoIntegracaoDTO {\n");
