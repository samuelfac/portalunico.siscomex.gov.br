...
import br.gov.siscomex.portalunico.catp.model.FabricanteIntegracaoRequestDTO;
import br.gov.siscomex.portalunico.catp.model.FabricanteIntegracaoResponseDTO;
...
public interface VinculosDeFabricanteProdutorAProdutoApi {
    ...
    @ApiOperation(value = "Exportar Vínculos de Fabricante-Produtor a Produto", notes = "", tags = {"Vinculos de Fabricante-Produtor a Produto"})
    @ApiResponses(value = {
    ...
    void downloadOperadorEstrangeiro(@ApiParam(value = "CPF ou CNPJ raiz da empresa responsável. Informar os 8 primeiros dígitos do CNPJ, suprimindo os pontos <br>Tamanho: 8 <br>Formato: 'NNNNNNNN' <br>Tamanho: 11 <br>Formato: 'NNNNNNNNNNN'", required = true) @PathParam("cpfCnpjRaiz") String cpfCnpjRaiz, @ApiParam(value = "JSON Web Token (JWT) contendo as informações do usuário. Este token é recuperado no parâmetro Set-Token no response da autenticação", required = true) @HeaderParam("Authorization") String authorization, @ApiParam(value = "Token de prevenção contra ataques CSRF. Este token é recuperado no parâmetro X-CSRF-Token no response da autenticação", required = true) @HeaderParam("X-CSRF-Token") String xCSRFToken);

    /**
     * **(Deprecated)** Vincular/Desvincular Fabricante-Produtor a Produto - Os novos endpoints substituirão o recurso atual, que será descontinuado/removido em 01/01/2026.
     *
     */
    @POST
    @Path("/ext/fabricante")
    ...
    @ApiOperation(value = "**(Deprecated)** Vincular/Desvincular Fabricante-Produtor a Produto - Os novos endpoints substituirão o recurso atual, que será descontinuado/removido em 01/01/2026. ", notes = "", tags = {"Vinculos de Fabricante-Produtor a Produto"})
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 403, message = "Usuário não tem permissão de acesso ao recurso"),
            @ApiResponse(code = 404, message = "Recurso não encontrado")})
    List<LoteValidacaoDTO> incluir(@ApiParam(value = "Lista de Fabricantes/Produtores", required = true) @Valid List<FabricanteIntegracaoDTO> body, @ApiParam(value = "JSON Web Token (JWT) contendo as informações do usuário. Este token é recuperado no parâmetro Set-Token no response da autenticação", required = true) @HeaderParam("Authorization") String authorization, @ApiParam(value = "Token de prevenção contra ataques CSRF. Este token é recuperado no parâmetro X-CSRF-Token no response da autenticação", required = true) @HeaderParam("X-CSRF-Token") String xCSRFToken);

    /**
     * Vincular Fabricante-Produtor a Produto
     *
     */
    @POST
    @Path("/ext/fabricante/{cpfCnpjRaiz}")
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Vincular Fabricante-Produtor a Produto", notes = "", tags = {"Vinculos de Fabricante-Produtor a Produto"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = FabricanteIntegracaoResponseDTO.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
            @ApiResponse(code = 500, message = "Erro interno no servidor"),
            ...
            @ApiResponse(code = 403, message = "Usuário não tem permissão de acesso ao recurso"),
            @ApiResponse(code = 404, message = "Recurso não encontrado")})
    FabricanteIntegracaoResponseDTO incluirFabricante(@ApiParam(value = "Fabricante/Produtor", required = true) @Valid FabricanteIntegracaoRequestDTO body, @ApiParam(value = "CPF ou CNPJ raiz da empresa responsável. Informar os 8 primeiros dígitos do CNPJ, suprimindo os pontos  <br>Tamanho: 8 <br>Formato: 'NNNNNNNN' <br>Tamanho: 11 <br>Formato: 'NNNNNNNNNNN'", required = true) @PathParam("cpfCnpjRaiz") String cpfCnpjRaiz, @ApiParam(value = "JSON Web Token (JWT) contendo as informações do usuário. Este token é recuperado no parâmetro Set-Token no response da autenticação", required = true) @HeaderParam("Authorization") String authorization, @ApiParam(value = "Token de prevenção contra ataques CSRF. Este token é recuperado no parâmetro X-CSRF-Token no response da autenticação", required = true) @HeaderParam("X-CSRF-Token") String xCSRFToken);

    /**
     * Desvincular Fabricante-Produtor a Produto
     *
     */
    @PUT
    @Path("/ext/fabricante/{cpfCnpjRaiz}")
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Desvincular Fabricante-Produtor a Produto", notes = "", tags = {"Vinculos de Fabricante-Produtor a Produto"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = FabricanteIntegracaoResponseDTO.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
            ...
            @ApiResponse(code = 403, message = "Usuário não tem permissão de acesso ao recurso"),
            @ApiResponse(code = 404, message = "Recurso não encontrado")})
    FabricanteIntegracaoResponseDTO remover(@ApiParam(value = "Fabricante/Produtor", required = true) @Valid FabricanteIntegracaoRequestDTO body, @ApiParam(value = "CPF ou CNPJ raiz da empresa responsável. Informar os 8 primeiros dígitos do CNPJ, suprimindo os pontos <br>Tamanho: 8 <br>Formato: 'NNNNNNNN' <br>Tamanho: 11 <br>Formato: 'NNNNNNNNNNN'", required = true) @PathParam("cpfCnpjRaiz") String cpfCnpjRaiz, @ApiParam(value = "JSON Web Token (JWT) contendo as informações do usuário. Este token é recuperado no parâmetro Set-Token no response da autenticação", required = true) @HeaderParam("Authorization") String authorization, @ApiParam(value = "Token de prevenção contra ataques CSRF. Este token é recuperado no parâmetro X-CSRF-Token no response da autenticação", required = true) @HeaderParam("X-CSRF-Token") String xCSRFToken);
}
