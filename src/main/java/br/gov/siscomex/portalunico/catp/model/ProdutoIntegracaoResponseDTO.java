...
public class ProdutoIntegracaoResponseDTO {
    ...
    public ProdutoIntegracaoResponseDTO denominacao(String denominacao) {
        this.denominacao = denominacao;
        return this;
    }
    ...
    public ProdutoIntegracaoResponseDTO atributos(List<ProdutoCampoSimplesIntegracaoDTO> atributos) {
        this.atributos = atributos;
        return this;
    }

    public ProdutoIntegracaoResponseDTO addAtributosItem(ProdutoCampoSimplesIntegracaoDTO atributosItem) {
    ...
    public ProdutoIntegracaoResponseDTO versao(String versao) {
        this.versao = versao;
        return this;
    }
