...
public class ConsultarMruc {
    ...
    public String toString() {
        ...
        sb.append(ConsultarMruc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConsultarMruc) == false) {
            return false;
        }
        ConsultarMruc rhs = ((ConsultarMruc) other);
