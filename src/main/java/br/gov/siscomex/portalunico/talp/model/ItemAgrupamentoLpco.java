...
public class ItemAgrupamentoLpco {
    ...
    @ApiModelProperty(example = "2019-09-02T10:04:38.123Z", required = true, value = "Data em que o LPCO foi incluído no agrupamento.<br>Formato: YYYY-MM-DD'T'HH:MI:SS.SSSZ")
    /**
     * Data em que o LPCO foi incluído no agrupamento.<br>Formato: YYYY-MM-DD'T'HH:MI:SS.SSSZ
     **/
