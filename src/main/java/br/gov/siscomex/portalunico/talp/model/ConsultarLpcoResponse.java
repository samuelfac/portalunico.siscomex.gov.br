...
public class ConsultarLpcoResponse {
    ...
    @ApiModelProperty(example = "2019-09-02T10:04:38.123Z", required = true, value = "Data em que o LPCO passou para sua situação atual<br> Formato: Formato: YYYY-MM-DD'T'HH:MI:SS.SSSZ")
    /**
