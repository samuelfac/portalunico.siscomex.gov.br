...
import br.gov.siscomex.portalunico.talp.model.ProrrogacaoLpcoAceitarRequest;
import br.gov.siscomex.portalunico.talp.model.ProrrogacaoLpcoNegarRequest;
import br.gov.siscomex.portalunico.talp.model.ProrrogacaoLpcoRequest;
import br.gov.siscomex.portalunico.talp.model.ProrrogacaoLpcoResponse;
...
public interface ProrrogacoesDeLpcosApi {
    ...
    @ApiOperation(value = "Aceitar solicitação de prorrogação de LPCO.", notes = "<p> Disponível apenas para a Administração Pública.</p>", tags = {"Prorrogacoes de LPCOs"})
    @ApiResponses(value = {
    ...
    @Consumes({"application/json"})
    @ApiOperation(value = "Alterar solicitação de prorrogação de LPCO.", notes = "", tags = {"Prorrogacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso"),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @ApiOperation(value = "Cancelar solicitação de prorrogação de LPCO.", notes = "", tags = {"Prorrogacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso"),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Consumes({"application/json"})
    @ApiOperation(value = "Negar solicitação de prorrogação de LPCO.", notes = "<p> Disponível apenas para a Administração Pública.</p>", tags = {"Prorrogacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso"),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Path("/ext/lpco/prorrogacao/{numLpco}")
    @Consumes({"application/json"})
    @ApiOperation(value = "Solicitar prorrogação de LPCO.", notes = "", tags = {"Prorrogacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso"),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
