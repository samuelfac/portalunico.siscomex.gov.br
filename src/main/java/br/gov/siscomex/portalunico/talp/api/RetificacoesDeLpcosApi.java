package br.gov.siscomex.portalunico.talp.api;

import br.gov.siscomex.portalunico.talp.model.LpcoDetalhado;
import br.gov.siscomex.portalunico.talp.model.RetificacaoLpcoAceitarRequest;
import br.gov.siscomex.portalunico.talp.model.RetificacaoLpcoCancelarRequest;
import br.gov.siscomex.portalunico.talp.model.RetificacaoLpcoNegarRequest;
import br.gov.siscomex.portalunico.talp.model.RetificacaoLpcoRequest;
import br.gov.siscomex.portalunico.talp.model.RetificacaoLpcoResponse;
import br.gov.siscomex.portalunico.talp.model.RevogacaoItemLpcoRequest;
...
public interface RetificacoesDeLpcosApi {
    ...
    @ApiOperation(value = "Aceitar solicitação de retificação de LPCO.", notes = "<p> Disponível apenas para a Administração Pública.</p>", tags = {"Retificacoes de LPCOs"})
    @ApiResponses(value = {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Cancelar solicitação de retificação de LPCO.", notes = "", tags = {"Retificacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = LpcoDetalhado.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Solicitar retificação de LPCO.", notes = "", tags = {"Retificacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = LpcoDetalhado.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Negar solicitação de retificação de LPCO.", notes = "<p> Disponível apenas para a Administração Pública.</p>", tags = {"Retificacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = LpcoDetalhado.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Path("/ext/lpco/retificacao/{numeroLpco}")
    @Produces({"application/json"})
    @ApiOperation(value = "Consultar solicitação de retificação de LPCO.", notes = "", tags = {"Retificacoes de LPCOs"})
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
            @ApiResponse(code = 500, message = "Erro interno no servidor")})
    RetificacaoLpcoResponse obterRetificacao(@ApiParam(value = "Número do LPCO a ser verificado.<br>Tamanho: 11<br>Formato: OAANNNNNNNN<br>Lei de formação: O número do LPCO é composto por:<br>* O = Operação (E para exportação, I para importação)<br>* AA = Ano do registro do LPCO<br>* NNNNNNNN = Número sequencial do LPCO no ano", required = true) @PathParam("numeroLpco") String numeroLpco, @ApiParam(value = "JSON Web Token (JWT) contendo as informações do usuário. Este token é recuperado no parâmetro Set-Token no response da autenticação", required = true) @HeaderParam("Authorization") String authorization, @ApiParam(value = "Token de prevenção contra ataques CSRF. Este token é recuperado no parâmetro X-CSRF-Token no response da autenticação", required = true) @HeaderParam("X-CSRF-Token") String xCSRFToken);
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Revogação de itens de LPCO de ofício.", notes = "<p> Disponível apenas para a Administração Pública.</p>", tags = {"Retificacoes de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = LpcoDetalhado.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
            ...
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
            @ApiResponse(code = 500, message = "Erro interno no servidor")})
    LpcoDetalhado revogarItensLpco(@ApiParam(value = "Número do LPCO para o qual serão revogados os itens.<br>Tamanho: 11<br>Formato: OAANNNNNNNN<br>Lei de formação: O número do LPCO é composto por:<br>* O = Operação (E para exportação, I para importação)<br>* AA = Ano do registro do LPCO<br>* NNNNNNNN = Número sequencial do LPCO no ano", required = true) @PathParam("numeroLpco") String numeroLpco, @ApiParam(value = "JSON Web Token (JWT) contendo as informações do usuário. Este token é recuperado no parâmetro Set-Token no response da autenticação", required = true) @HeaderParam("Authorization") String authorization, @ApiParam(value = "Token de prevenção contra ataques CSRF. Este token é recuperado no parâmetro X-CSRF-Token no response da autenticação", required = true) @HeaderParam("X-CSRF-Token") String xCSRFToken, @ApiParam(value = "") @Valid RevogacaoItemLpcoRequest body);
}
