...
public class LpcoDetalhado {
    ...
    @ApiModelProperty(example = "2019-09-02T10:04:38.123Z", value = "Data de hora da presença de carga. Disponível apenas em LPCOs com LI vinculada.<br>Formato: YYYY-MM-DD'T'HH:MI:SS.SSSZ")
    /**
