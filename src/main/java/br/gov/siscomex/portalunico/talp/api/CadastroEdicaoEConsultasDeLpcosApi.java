...
import br.gov.siscomex.portalunico.talp.model.ConsultarLpcoResponse;
import br.gov.siscomex.portalunico.talp.model.EmbarqueCarga;
import br.gov.siscomex.portalunico.talp.model.IncluirLpcoRequest;
import br.gov.siscomex.portalunico.talp.model.ItemHistoricoLpcoResponse;
import br.gov.siscomex.portalunico.talp.model.LpcoDetalhado;
import br.gov.siscomex.portalunico.talp.model.MensagemLpcoRequest;
import br.gov.siscomex.portalunico.talp.model.NovaTentativaPagamentoExternalDTO;
import br.gov.siscomex.portalunico.talp.model.PagamentoTaxa;
import br.gov.siscomex.portalunico.talp.model.PresencaCarga;
...
public interface CadastroEdicaoEConsultasDeLpcosApi {
    ...
    @ApiOperation(value = "Alterar um pedido de LPCO.", notes = "", tags = {"Cadastro, edicao e consultas de LPCOs"})
    @ApiResponses(value = {
    ...
    /**
     * Download do certificado de origem.
     *
     */
    @GET
    ...
    /**
     * Download de zip com todos os ceriticados de origem associados a um LPCO.
     *
     */
    @GET
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Cadastrar um pedido de LPCO.", notes = "", tags = {"Cadastro, edicao e consultas de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = LpcoDetalhado.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Consumes({"application/json"})
    @ApiOperation(value = "Inserir mensagem nos histórico do LPCO.", notes = "", tags = {"Cadastro, edicao e consultas de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso"),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
    ...
    @Path("/ext/lpco/{numero}")
    @Produces({"application/json"})
    @ApiOperation(value = "Detalhar um pedido de LPCO.", notes = "", tags = {"Cadastro, edicao e consultas de LPCOs"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = LpcoDetalhado.class),
            @ApiResponse(code = 400, message = "Requisição mal formatada"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
