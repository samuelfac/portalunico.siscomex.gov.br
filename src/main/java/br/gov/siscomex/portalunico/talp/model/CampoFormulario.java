...
public class CampoFormulario {
    ...
    public enum CodigoEnum {
        ...
        @XmlEnumValue("DETALHAMENTO_OPERACAO_SEM_NOTA")
        @JsonProperty("DETALHAMENTO_OPERACAO_SEM_NOTA")
        DETALHAMENTO_OPERACAO_SEM_NOTA("DETALHAMENTO_OPERACAO_SEM_NOTA"),

        @XmlEnumValue("DET IMPORTADOR")
        @JsonProperty("DET IMPORTADOR")
        DET_IMPORTADOR("DET IMPORTADOR"),
        ...
        @XmlEnumValue("LPCO_VINCULADO")
        @JsonProperty("LPCO_VINCULADO")
        LPCO_VINCULADO("LPCO_VINCULADO"),

        @XmlEnumValue("DENOMINACAO_PRODUTO")
        @JsonProperty("DENOMINACAO_PRODUTO")
        DENOMINACAO_PRODUTO("DENOMINACAO_PRODUTO"),

        @XmlEnumValue("PESO_LIQUIDO_ITEM")
        @JsonProperty("PESO_LIQUIDO_ITEM")
        PESO_LIQUIDO_ITEM("PESO_LIQUIDO_ITEM"),

        @XmlEnumValue("MOTIVO_SITUACAO_ESPECIAL")
        @JsonProperty("MOTIVO_SITUACAO_ESPECIAL")
        MOTIVO_SITUACAO_ESPECIAL("MOTIVO_SITUACAO_ESPECIAL"),
