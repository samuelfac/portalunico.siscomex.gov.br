...
import br.gov.siscomex.portalunico.talp.model.DispensaPagamentoLpcoRequest;
...
public interface PagamentoDeTaxasDeLpcoApi {
     ...
     */
    @PUT
    @Path("/ext/lpco/pagamento/{numeroLpco}/dispensar")
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Dispensar o pagamento de uma taxa do LPCO.", notes = "<p> Disponível apenas para a Administração Pública.</p>", tags = {"Pagamento de taxas de LPCO"})
    @ApiResponses(value = {
