...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "ConsultaDetalhadaExigencia", propOrder =
    { "cpfCancelamento", "cpfRegistro", "dataCumprimento", "dataRegistro", "descricao", "idLpco", "nomeUsuarioCancelamento", "nomeUsuarioRegistro", "numero", "situacao", "textoCumprimento", "textoJustificativa"
})
