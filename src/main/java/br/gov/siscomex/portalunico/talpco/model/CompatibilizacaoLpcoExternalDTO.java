...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "CompatibilizacaoLpcoExternalDTO", propOrder =
    { "dataRegistro", "justificativa", "listaAlteracoes", "numero", "situacao"
})

@XmlRootElement(name="CompatibilizacaoLpcoExternalDTO")
public class CompatibilizacaoLpcoExternalDTO  {
  ...
  **/
  ...
  public CompatibilizacaoLpcoExternalDTO dataRegistro(String dataRegistro) {
    this.dataRegistro = dataRegistro;
    return this;
  }
  ...
  **/
  ...
  public CompatibilizacaoLpcoExternalDTO justificativa(String justificativa) {
    this.justificativa = justificativa;
    return this;
  }
  ...
  **/
  ...
  public CompatibilizacaoLpcoExternalDTO listaAlteracoes(List<DadosAlteracoesLpco> listaAlteracoes) {
    this.listaAlteracoes = listaAlteracoes;
    return this;
  }

  public CompatibilizacaoLpcoExternalDTO addListaAlteracoesItem(DadosAlteracoesLpco listaAlteracoesItem) {
  ...
  **/
  ...
  public CompatibilizacaoLpcoExternalDTO numero(String numero) {
    this.numero = numero;
    return this;
  }
  ...
  **/
  ...
  public CompatibilizacaoLpcoExternalDTO situacao(IdDescricao situacao) {
    this.situacao = situacao;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class CompatibilizacaoLpcoExternalDTO {\n");
