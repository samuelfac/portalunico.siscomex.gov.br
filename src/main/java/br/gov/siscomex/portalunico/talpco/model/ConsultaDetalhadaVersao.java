...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "ConsultaDetalhadaVersao", propOrder =
    { "id", "idLpco", "numero", "dataRegistro", "situacao", "dataAnalise", "informacoesAdicionais", "atual", "dataInicioVigencia", "dataFimVigencia", "novaDataFimVigenciaSolicitada", "justificativaSolicitacaoProrrogacao", "dataCadastroSolicitacaoProrrogacao", "dataUltimaAlteracao", "grupos", "itensHistorico", "vinculos"
})
