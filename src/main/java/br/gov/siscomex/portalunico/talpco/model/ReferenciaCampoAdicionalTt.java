...
public class ReferenciaCampoAdicionalTt  {
  ...
  @ApiModelProperty(required = true, value = "Código do atributo relacionado ao campo adicional.<br>Tamanho mínimo: 5<br>Tamanho máximo: 40")
 /**
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Valor do campo adicional.<br>Tamanho mínimo: 1<br>Tamanho máximo: 4000")
 /**
