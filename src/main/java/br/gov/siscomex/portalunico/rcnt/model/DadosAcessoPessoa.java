...
@XmlType(name = "DadosAcessoPessoa", propOrder =
        {"listaCameras", "identificacao", "catraca", "idEvento", "dataHoraRegistro", "direcao", "dataHoraOcorrencia", "nome", "tipoOperacao", "cpfOperadorRegistro", "protocoloEventoRetificadoOuExcluido", "voo", "codigoRecinto", "cpf", "identidadeEstrangeiro", "reserva", "cpfOperadorOcorrencia", "contingencia"
        })
