...
public class DadosVolumeVerificadoMadeiraObrigatorio {
    ...
    @ApiModelProperty(example = "13", required = true, value = "Quantidade de volumes. Pode ser nulo quando o evento for de exclusão.")
    /**
     * Quantidade de volumes. Pode ser nulo quando o evento for de exclusão.
     **/
    private Integer quantidade = null;

    @XmlElement(name = "madeira", required = true)
    @ApiModelProperty(example = "false", required = true, value = "Informar se a embalagem contém madeira. Pode ser nulo quando o evento for de exclusão.<br/>Domínio:<br/>true - Sim<br/>false - Não")
    /**
     * Informar se a embalagem contém madeira. Pode ser nulo quando o evento for de exclusão.<br/>Domínio:<br/>true - Sim<br/>false - Não
     **/
    ...
    public DadosVolumeVerificadoMadeiraObrigatorio tipo(String tipo) {
        this.tipo = tipo;
        return this;
    }
    ...
    public DadosVolumeVerificadoMadeiraObrigatorio idElemento(String idElemento) {
        this.idElemento = idElemento;
        return this;
    }
    ...
    public DadosVolumeVerificadoMadeiraObrigatorio quantidade(Integer quantidade) {
        this.quantidade = quantidade;
        return this;
    }
    ...
    public DadosVolumeVerificadoMadeiraObrigatorio madeira(Boolean madeira) {
        this.madeira = madeira;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class DadosVolumeVerificadoMadeiraObrigatorio {\n" +
