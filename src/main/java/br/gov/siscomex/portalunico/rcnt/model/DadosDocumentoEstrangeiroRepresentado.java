...
@XmlType(name = "DadosDocumentoEstrangeiroRepresentado", propOrder =
        {"numero", "paisEmissor", "tipo", "validade"
        })

@XmlRootElement(name = "DadosDocumentoEstrangeiroRepresentado")
/**
 * Documento de estrangeiro do representado pessoa física.
 **/
@ApiModel(description = "Documento de estrangeiro do representado pessoa física.")
public class DadosDocumentoEstrangeiroRepresentado {
    ...
    public DadosDocumentoEstrangeiroRepresentado numero(String numero) {
        this.numero = numero;
        return this;
    }
    ...
    public DadosDocumentoEstrangeiroRepresentado paisEmissor(String paisEmissor) {
        this.paisEmissor = paisEmissor;
        return this;
    }
    ...
    public DadosDocumentoEstrangeiroRepresentado tipo(TipoEnum tipo) {
        this.tipo = tipo;
        return this;
    }
    ...
    public DadosDocumentoEstrangeiroRepresentado validade(String validade) {
        this.validade = validade;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class DadosDocumentoEstrangeiroRepresentado {\n" +
