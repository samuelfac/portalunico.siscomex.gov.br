...
@XmlType(name = "DadosDocumentoEstrangeiroSemCPF", propOrder =
        {"numero", "paisEmissor", "tipo", "validade"
        })

@XmlRootElement(name = "DadosDocumentoEstrangeiroSemCPF")
/**
 * Informar apenas no caso de estrangeiro sem CPF
 **/
@ApiModel(description = "Informar apenas no caso de estrangeiro sem CPF")
public class DadosDocumentoEstrangeiroSemCPF {
    ...
    public DadosDocumentoEstrangeiroSemCPF numero(String numero) {
        this.numero = numero;
        return this;
    }
    ...
    public DadosDocumentoEstrangeiroSemCPF paisEmissor(String paisEmissor) {
        this.paisEmissor = paisEmissor;
        return this;
    }
    ...
    public DadosDocumentoEstrangeiroSemCPF tipo(TipoEnum tipo) {
        this.tipo = tipo;
        return this;
    }
    ...
    public DadosDocumentoEstrangeiroSemCPF validade(String validade) {
        this.validade = validade;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class DadosDocumentoEstrangeiroSemCPF {\n" +
