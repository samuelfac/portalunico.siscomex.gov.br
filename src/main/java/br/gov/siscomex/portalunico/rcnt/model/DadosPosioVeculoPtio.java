...
public enum TipoOperacaoEnum {
  ...
  **/
  ...
  @XmlElement(name="box")
  @ApiModelProperty(value = "Box indicativo da localização do veículo<br/>Tamanho: 100")
 /**
   * Box indicativo da localização do veículo<br/>Tamanho: 100
  **/
