...
@XmlType(name = "DadosDaChegadaAoPontoZero", propOrder =
        {"viagem", "identificacaoUld", "idEvento", "dataHoraRegistro", "codigoRecinto", "dataHoraOcorrencia", "tipoOperacao", "cpfOperadorOcorrencia", "cpfOperadorRegistro", "protocoloEventoRetificadoOuExcluido", "contingencia"
        })
