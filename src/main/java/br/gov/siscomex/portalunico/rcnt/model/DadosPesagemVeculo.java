...
@XmlType(name = "DadosPesagemVeculo", propOrder =
        {"ocrPlaca", "dataHoraOcorrencia", "cpfOperadorRegistro", "listaNfe", "balanca", "pesoBrutoManifesto", "codigoRecinto", "correiasTransportadoras", "ncm", "placa", "listaConteineresUld", "dutos", "listaCameras", "listaManifestos", "idEvento", "pesoBrutoBalanca", "dataHoraRegistro", "tara", "tipoOperacao", "protocoloEventoRetificadoOuExcluido", "volume", "taraConjunto", "capturaAutoPeso", "vazio", "listaSemirreboque", "cpfOperadorOcorrencia", "contingencia"
        })
