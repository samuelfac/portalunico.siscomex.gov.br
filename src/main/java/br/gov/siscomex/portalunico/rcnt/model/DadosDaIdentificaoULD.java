...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "DadosDaIdentificaoULD", propOrder =
    { "idElemento", "identificacaoUld"
})

@XmlRootElement(name="DadosDaIdentificaoULD")
public class DadosDaIdentificaoULD  {
  ...
  **/
  ...
  public DadosDaIdentificaoULD idElemento(String idElemento) {
    this.idElemento = idElemento;
    return this;
  }
  ...
  **/
  ...
  public DadosDaIdentificaoULD identificacaoUld(String identificacaoUld) {
    this.identificacaoUld = identificacaoUld;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class DadosDaIdentificaoULD {\n");
