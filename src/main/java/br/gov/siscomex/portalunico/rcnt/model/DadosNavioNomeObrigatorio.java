...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "DadosNavioNomeObrigatorio", propOrder =
    { "imo", "nome"
})

@XmlRootElement(name="DadosNavioNomeObrigatorio")
public class DadosNavioNomeObrigatorio  {
  ...
  **/
  ...
  public DadosNavioNomeObrigatorio imo(String imo) {
    this.imo = imo;
    return this;
  }
  ...
  **/
  ...
  public DadosNavioNomeObrigatorio nome(String nome) {
    this.nome = nome;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class DadosNavioNomeObrigatorio {\n");
