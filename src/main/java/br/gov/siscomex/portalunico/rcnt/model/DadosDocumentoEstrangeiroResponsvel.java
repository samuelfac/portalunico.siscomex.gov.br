...
@XmlAccessorType(XmlAccessType.FIELD)
 @XmlType(name = "DadosDocumentoEstrangeiroResponsvel", propOrder =
    { "numero", "paisEmissor", "tipo", "validade"
})

@XmlRootElement(name="DadosDocumentoEstrangeiroResponsvel")
/**
  * Documento de estrangeiro responsável pelo veículo credenciado quando pessoa física
 **/
@ApiModel(description="Documento de estrangeiro responsável pelo veículo credenciado quando pessoa física")
public class DadosDocumentoEstrangeiroResponsvel  {
...
public enum TipoEnum {
  ...
  **/
  ...
  public DadosDocumentoEstrangeiroResponsvel numero(String numero) {
    this.numero = numero;
    return this;
  }
  ...
  **/
  ...
  public DadosDocumentoEstrangeiroResponsvel paisEmissor(String paisEmissor) {
    this.paisEmissor = paisEmissor;
    return this;
  }
  ...
  **/
  ...
  public DadosDocumentoEstrangeiroResponsvel tipo(TipoEnum tipo) {
    this.tipo = tipo;
    return this;
  }
  ...
  **/
  ...
  public DadosDocumentoEstrangeiroResponsvel validade(String validade) {
    this.validade = validade;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class DadosDocumentoEstrangeiroResponsvel {\n");
