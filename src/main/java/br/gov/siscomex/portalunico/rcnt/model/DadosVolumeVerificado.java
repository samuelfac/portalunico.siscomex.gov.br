...
public class DadosVolumeVerificado {
    ...
    @ApiModelProperty(example = "false", value = "Informar se a embalagem contém madeira. Pode ser nulo quando o evento for de exclusão.<br/>Domínio:<br/>true - Sim<br/>false - Não")
    /**
    ...
    public DadosVolumeVerificado tipo(String tipo) {
        this.tipo = tipo;
        return this;
    }
    ...
    public DadosVolumeVerificado quantidade(Integer quantidade) {
        this.quantidade = quantidade;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class DadosVolumeVerificado {\n" +
