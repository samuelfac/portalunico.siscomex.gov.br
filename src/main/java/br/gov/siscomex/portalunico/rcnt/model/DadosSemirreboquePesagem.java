...
public class DadosSemirreboquePesagem  {
  ...
  **/
  ...
  @ApiModelProperty(example = "50.0", value = "Tara do veículo. Para os casos em que a tara é aferida separadamente (cavalo / semireboque). Cadastro de taras comum no modal rodoviário.<br/><br/>tara, até 4 casas decimais.")
  @Valid
 /**
