...
public class DadosDoTipoDeAvariaExtravio {
    ...
    public DadosDoTipoDeAvariaExtravio tipoAvaria(TipoAvariaEnum tipoAvaria) {
        this.tipoAvaria = tipoAvaria;
        return this;
    }
    ...
    public DadosDoTipoDeAvariaExtravio idElemento(String idElemento) {
        this.idElemento = idElemento;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class DadosDoTipoDeAvariaExtravio {\n" +
