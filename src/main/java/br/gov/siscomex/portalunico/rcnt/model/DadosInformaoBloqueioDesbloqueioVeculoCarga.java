...
@XmlType(name = "DadosInformaoBloqueioDesbloqueioVeculoCarga", propOrder =
        {"motivo", "idEvento", "numeroManifesto", "solicitante", "dataHoraRegistro", "dataHoraOcorrencia", "numeroConteiner", "tipoOperacao", "numeroDeclaracao", "listaLotes", "cpfOperadorRegistro", "protocoloEventoRetificadoOuExcluido", "tipoConhecimento", "setorSolicitante", "tipoDeclaracao", "numeroConhecimentoMAWB", "identificacaoUld", "codigoRecinto", "numeroConhecimento", "tipoManifesto", "cpfOperadorOcorrencia", "contingencia", "status", "placa"
        })
...
public class DadosInformaoBloqueioDesbloqueioVeculoCarga {
    ...
    public String toString() {
        ...
        String sb = "class DadosInformaoBloqueioDesbloqueioVeculoCarga {\n" +
