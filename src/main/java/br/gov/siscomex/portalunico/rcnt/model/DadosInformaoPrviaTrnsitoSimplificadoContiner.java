...
@XmlType(name = "DadosInformaoPrviaTrnsitoSimplificadoContiner", propOrder =
        {"idEvento", "dataHoraAtracacao", "dataHoraRegistro", "dataHoraOcorrencia", "tipoOperacao", "cpfOperadorRegistro", "protocoloEventoRetificadoOuExcluido", "viagem", "navio", "listaCargas", "codigoRecinto", "escala", "cpfOperadorOcorrencia", "contingencia"
        })
...
public class DadosInformaoPrviaTrnsitoSimplificadoContiner {
    ...
    public String toString() {
        ...
        String sb = "class DadosInformaoPrviaTrnsitoSimplificadoContiner {\n" +
