...
@XmlType(name = "DadosIndisponibilidadeEquipamento", propOrder =
        {"idEvento", "dataHoraRegistro", "dataHoraOcorrencia", "tipoOperacao", "cpfOperadorRegistro", "protocoloEventoRetificadoOuExcluido", "dataHoraPrevisaoDisponibilidade", "motivoIndisponibilidade", "equipamento", "codigoRecinto", "disponivel", "cpfOperadorOcorrencia", "contingencia"
        })
...
public class DadosIndisponibilidadeEquipamento {
    ...
    public String toString() {
        ...
        String sb = "class DadosIndisponibilidadeEquipamento {\n" +
