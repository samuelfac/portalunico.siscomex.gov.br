...
@XmlType(name = "DadosGeraoLote", propOrder =
        {"listaVolumesManifesto", "pesoManifesto", "perecivel", "indicadorDeRemessaInternacional", "dataHoraOcorrencia", "listaChassi", "cpfOperadorRegistro", "tipoConhecimento", "codigoRecintoOrigem", "listaNfe", "viagem", "numeroConhecimentoMAWB", "aeroportoOrigem", "listaDeclaracaoAduaneira", "codigoRecinto", "numeroConhecimento", "lotes", "escala", "placa", "listaMercadoriaPerigosa", "listaCameras", "areaCargaSolta", "idEvento", "numeroManifesto", "cargaSolta", "dataHoraRegistro", "numeroRUC", "numeroConteiner", "tipoOperacao", "protocoloEventoRetificadoOuExcluido", "declaracaoAduaneira", "cnpjResponsavelAnterior", "placaSemirreboque", "navio", "identificacaoUld", "iataAeronave", "tipoManifesto", "prefixoAeronave", "observacaoRecepcao", "cpfOperadorOcorrencia", "contingencia", "listaMalas"
        })
...
public class DadosGeraoLote {
    ...
    public String toString() {
        ...
        String sb = "class DadosGeraoLote {\n" +
