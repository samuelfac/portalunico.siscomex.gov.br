...
@XmlType(name = "DuimpItemBalancaComercialCover", propOrder =
        {"atributosDuimp", "identificacao", "indicadorExportadorFabricante", "lpcos", "exportador", "mercadoria", "dadosCambiais", "condicaoVenda", "tributos", "produto", "caracterizacaoImportacao", "indicadorCompradorVendedor", "fabricante", "atributosFundamentoLegalDuimp"
        })
