...
@XmlType(name = "SefazItemCover", propOrder =
        {"vinculacaoCompradorVendedor", "lpcos", "informacoesAdicionais", "dadosOperadorExportador", "declaracoesExportacaoEstrangeira", "declaracoesVinculadas", "dadosCambiais", "dadosInsumoDrawbackIsencao", "condicaoVendaMercadoria", "relacaoExportadorFabricante", "informacoesComplementares", "dadosProduto", "itemTributo", "caracterizacaoImportacao", "dadosOperadorFabricante", "numeroItem"
        })
