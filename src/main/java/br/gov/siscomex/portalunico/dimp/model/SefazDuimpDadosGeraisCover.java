...
public class SefazDuimpDadosGeraisCover {
    ...
    @ApiModelProperty(example = "2019-01-30'T'18:38:58.789-0300", required = true, value = "Data e hora do registro da versão original da declaração.<br>Formato: 'yyyy-MM-dd'T'HH:mm:ss.SSSZ'")
    /**
    ...
    public SefazDuimpDadosGeraisCover dataHoraCriacao(String dataHoraCriacao) {
        this.dataHoraCriacao = dataHoraCriacao;
        return this;
    }
    ...
    public SefazDuimpDadosGeraisCover dataHoraRegistro(String dataHoraRegistro) {
        this.dataHoraRegistro = dataHoraRegistro;
        return this;
    }
    ...
    public SefazDuimpDadosGeraisCover ufImportador(String ufImportador) {
        this.ufImportador = ufImportador;
        return this;
    }
    ...
    public SefazDuimpDadosGeraisCover equipesTrabalho(List<DadosDeEquipeDeTrabalho> equipesTrabalho) {
        this.equipesTrabalho = equipesTrabalho;
        return this;
    }

    public SefazDuimpDadosGeraisCover addEquipesTrabalhoItem(DadosDeEquipeDeTrabalho equipesTrabalhoItem) {
