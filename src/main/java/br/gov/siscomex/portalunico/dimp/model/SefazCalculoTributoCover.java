...
@XmlType(name = "SefazCalculoTributoCover", propOrder =
        {"percReducaoBaseCalculo", "valorCalculado", "imposto", "percReducaoAliquotaReduzida", "valorBaseCalculo", "tipoAliquota", "impostoARecolher", "percentualPagamentoProporcional", "valorCalculadoPagamentoProporcional", "valorAliquotaEspecifica", "indicadorTributado", "valorAliquota", "valorDevido", "fundamentoLegalNormal", "valorBaseCalculoEspecifica", "valorNormal", "valorAliquotaReduzida", "valorSuspenso", "valorOriginalmenteDevido", "valorBaseCalculoReduzida", "valorAReduzir"
        })
