...
public class FreteCover {
    ...
    @ApiModelProperty(example = "30.12", required = true, value = "Valor do frete na moeda negociada.<br>Tamanho: 13,2<br>Formato: Decimal, com até 2 casas decimais separadas por ponto.")
    /**
