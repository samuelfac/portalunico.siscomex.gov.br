...
public class PalavraChaveDocumentoInstrucaoCover {
    ...
    @ApiModelProperty(example = "33", required = true, value = "Código da palavra-chave no sistema Anexação.<br>Domínio: Palavras-Chave existentes no sistema Anexação (E-Docex).<br>Valor mínimo: 1<br>Valor máximo: 999")
    /**
    ...
    @ApiModelProperty(example = "9999.99.99", required = true, value = "Valor informado pelo importador para a palavra-chave.")
    /**
