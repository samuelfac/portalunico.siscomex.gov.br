...
import br.gov.siscomex.portalunico.dimp.model.ValoresCalculadosDuimpCover;
...
public interface DadosGeraisDaDuimpApi {
     ...
     */
    @GET
    @Path("/duimp/{numero-duimp}/{versao-duimp}/valores-calculados")
