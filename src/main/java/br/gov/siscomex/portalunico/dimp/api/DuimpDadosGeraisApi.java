...
import br.gov.siscomex.portalunico.dimp.model.DuimpBalancaComercialCover;
...
public interface DuimpDadosGeraisApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 204, message = "Operação realizada com sucesso. Nenhum dado será retornado.", response = DuimpBalancaComercialCover.class),
