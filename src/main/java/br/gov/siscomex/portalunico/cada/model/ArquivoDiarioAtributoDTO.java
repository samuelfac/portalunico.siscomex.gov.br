...
@XmlType(name = "ArquivoDiarioAtributoDTO", propOrder =
        {"orgaos", "obrigatorio", "brid", "wcoid", "dominio", "formaPreenchimento", "definicao", "orientacaoPreenchimento", "nomeApresentacao", "multivalorado", "casasDecimais", "atributoCondicionante", "objetivos", "tamanhoMaximo", "tipoAtributo", "atributoFiltro", "codigo", "nome", "listaSubatributos", "dataFimVigencia", "condicionados", "informacaoAdicional", "mascara", "dataInicioVigencia", "modalidade"
        })
