...
public interface RelacaoDeAtributosPorFundamentoLegalApi {
    ...
    @ApiOperation(value = "Consulta da relação de atributos por Fundamento Legal", notes = "", tags = {"Relacao de Atributos por Fundamento Legal"})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Download do arquivo com a relação de atributos por Fundamento Legal", notes = "", tags = {"Relacao de Atributos por Fundamento Legal"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso"),
            @ApiResponse(code = 400, message = "Requisição inválida"),
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
