package br.gov.siscomex.portalunico.cada.api;

import br.gov.siscomex.portalunico.cada.model.ArquivoDiarioAtributoDTO;
import br.gov.siscomex.portalunico.cada.model.AtributoConsultaFiltroCodigoDTO;
import br.gov.siscomex.portalunico.cada.model.AtributoConsultaFiltroNomeDTO;
import br.gov.siscomex.portalunico.cada.model.ChangeLogArquivoDiarioAtributoDTO;
...
public interface RelacaoDeAtributosApi {
    ...
    @ApiOperation(value = "Consulta de dados de atributos pelo código", notes = "", tags = {"Relacao de Atributos"})
    @ApiResponses(value = {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @ApiOperation(value = "Consulta de dados de atributos pelo nome", notes = "", tags = {"Relacao de Atributos"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = ArquivoDiarioAtributoDTO.class),
            @ApiResponse(code = 400, message = "Requisição inválida"),
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
    ...
    @ApiOperation(value = "Download do arquivo com a relação de atributos, independente dos vínculos", notes = "", tags = {"Relacao de Atributos"})
    @ApiResponses(value = {
    ...
    @Produces({"application/json"})
    @ApiOperation(value = "Consulta histórico de versões", notes = "", tags = {"Relacao de Atributos"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Operação realizada com sucesso", response = ChangeLogArquivoDiarioAtributoDTO.class, responseContainer = "List"),
            @ApiResponse(code = 400, message = "Requisição inválida"),
            @ApiResponse(code = 422, message = "Erro(s) de validação da camada de negócio"),
            @ApiResponse(code = 401, message = "Usuário não autenticado ou autenticação inválida"),
            @ApiResponse(code = 500, message = "Erro interno no servidor"),
