...
public class SefazExportadorEstrangeiroCover {
    ...
    public SefazExportadorEstrangeiroCover relacaoExportadorFabricante(RelacaoExportadorFabricanteEnum relacaoExportadorFabricante) {
        this.relacaoExportadorFabricante = relacaoExportadorFabricante;
        return this;
    }
    ...
    public SefazExportadorEstrangeiroCover vinculacaoCompradorVendedor(VinculacaoCompradorVendedorEnum vinculacaoCompradorVendedor) {
        this.vinculacaoCompradorVendedor = vinculacaoCompradorVendedor;
        return this;
    }
    ...
    public SefazExportadorEstrangeiroCover codigoOperadorExportador(String codigoOperadorExportador) {
        this.codigoOperadorExportador = codigoOperadorExportador;
        return this;
    }
    ...
    public SefazExportadorEstrangeiroCover paisOperadorExportador(PasDeProcednciaDaMercadoriaObjetoCompostoPelosAtributosCdigoEDescrio paisOperadorExportador) {
        this.paisOperadorExportador = paisOperadorExportador;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class SefazExportadorEstrangeiroCover {\n" +
