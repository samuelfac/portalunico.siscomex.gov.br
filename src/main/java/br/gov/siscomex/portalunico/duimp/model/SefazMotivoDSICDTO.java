...
public class SefazMotivoDSICDTO {
    ...
    @ApiModelProperty(example = "AWB", value = "Indica o motivo para utilização do Tipo de Conhecimento DSIC")
    /**
    ...
    @ApiModelProperty(example = "AWB", value = "Indica o submotivo  quando o 'motivo' informado for 'Bagagem/Desdobramento'")
    /**
