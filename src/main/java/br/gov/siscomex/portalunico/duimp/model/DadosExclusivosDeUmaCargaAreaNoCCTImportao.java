...
@XmlType(name = "DadosExclusivosDeUmaCargaAreaNoCCTImportao", propOrder =
        {"tipoConhecimento", "motivoDSIC", "quantidadeVolumes", "componentesFrete"
        })

@XmlRootElement(name = "DadosExclusivosDeUmaCargaAreaNoCCTImportao")
public class DadosExclusivosDeUmaCargaAreaNoCCTImportao {
    ...
    public DadosExclusivosDeUmaCargaAreaNoCCTImportao tipoConhecimento(TipoConhecimentoEnum tipoConhecimento) {
        this.tipoConhecimento = tipoConhecimento;
        return this;
    }
    ...
    public DadosExclusivosDeUmaCargaAreaNoCCTImportao motivoDSIC(SefazMotivoDSICDTO motivoDSIC) {
        this.motivoDSIC = motivoDSIC;
        return this;
    }
    ...
    public DadosExclusivosDeUmaCargaAreaNoCCTImportao quantidadeVolumes(Integer quantidadeVolumes) {
        this.quantidadeVolumes = quantidadeVolumes;
        return this;
    }
    ...
    public DadosExclusivosDeUmaCargaAreaNoCCTImportao componentesFrete(DadosDosComponentesDeFreteDeUmaCargaArea componentesFrete) {
        this.componentesFrete = componentesFrete;
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class DadosExclusivosDeUmaCargaAreaNoCCTImportao {\n" +
