...
public class SefazPagamentoCover {
    ...
    @Valid
    private SefazPagamentoJurosCover pagamentoJuros = null;
    ...
    public SefazPagamentoCover banco(String banco) {
        this.banco = banco;
        return this;
    }
    ...
    public SefazPagamentoCover dataHoraPagamento(OffsetDateTime dataHoraPagamento) {
        this.dataHoraPagamento = dataHoraPagamento;
        return this;
    }
    ...
    public SefazPagamentoJurosCover getPagamentoJuros() {
        return pagamentoJuros;
    }

    public void setPagamentoJuros(SefazPagamentoJurosCover pagamentoJuros) {
        this.pagamentoJuros = pagamentoJuros;
    }

    public SefazPagamentoCover pagamentoJuros(SefazPagamentoJurosCover pagamentoJuros) {
        this.pagamentoJuros = pagamentoJuros;
        return this;
    }
