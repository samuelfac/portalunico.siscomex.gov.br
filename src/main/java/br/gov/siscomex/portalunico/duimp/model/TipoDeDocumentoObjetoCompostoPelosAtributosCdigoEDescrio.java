...
public class TipoDeDocumentoObjetoCompostoPelosAtributosCdigoEDescrio  {
  ...
  **/
  ...
  @ApiModelProperty(example = "Atestado de inexistência de produção nacional", value = "Descrição correspondente ao valor informado no atributo 'codigo'. <br>Tamanho mínimo: 1<br>Tamanho máximo: 80")
 /**
