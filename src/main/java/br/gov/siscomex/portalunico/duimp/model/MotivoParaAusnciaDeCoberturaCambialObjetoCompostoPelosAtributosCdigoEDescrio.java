...
public class MotivoParaAusnciaDeCoberturaCambialObjetoCompostoPelosAtributosCdigoEDescrio  {
  ...
  **/
  ...
  @ApiModelProperty(example = "ADMISSAO EM REGIME ADUANEIRO ESPECIAL OU ATIPICO", value = "Descrição correspondente ao valor informado no atributo 'codigo'. <br>Tamanho mínimo: 1<br>Tamanho máximo: 80")
 /**
