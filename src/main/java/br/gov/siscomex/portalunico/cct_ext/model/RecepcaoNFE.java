...
@XmlRootElement(name="RecepcaoNFE")
/**
...
public class RecepcaoNFE  {
  ...
  **/
  ...
  @ApiModelProperty(example = "Informação de referência do local da recepção", value = "Informação de referência do local da recepção<br>Tamanho: 150")
 /**
  ...
  **/
  ...
  @ApiModelProperty(example = "Motivo da não realização da pesagem", value = "Motivo da não realização da pesagem<br>Tamanho: 250<br>Deve ser informado somente quando não há informação de pesagem.")
 /**
  ...
  **/
  ...
  @ApiModelProperty(example = "localArmazenamento", value = "Local de armazenamento da carga<br>Tamanho: 150")
 /**
  ...
  **/
  ...
  public RecepcaoNFE identificacaoRecepcao(String identificacaoRecepcao) {
    this.identificacaoRecepcao = identificacaoRecepcao;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE cnpjResp(String cnpjResp) {
    this.cnpjResp = cnpjResp;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE local(Local local) {
    this.local = local;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE refLocalRecepcao(String refLocalRecepcao) {
    this.refLocalRecepcao = refLocalRecepcao;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE notasFiscais(NotasFiscais notasFiscais) {
    this.notasFiscais = notasFiscais;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE transportador(Transportador transportador) {
    this.transportador = transportador;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE pesoAferido(BigDecimal pesoAferido) {
    this.pesoAferido = pesoAferido;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE motivoNaoPesagem(String motivoNaoPesagem) {
    this.motivoNaoPesagem = motivoNaoPesagem;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE localArmazenamento(String localArmazenamento) {
    this.localArmazenamento = localArmazenamento;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE codigoIdentCarga(String codigoIdentCarga) {
    this.codigoIdentCarga = codigoIdentCarga;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE avariasIdentificadas(String avariasIdentificadas) {
    this.avariasIdentificadas = avariasIdentificadas;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE divergenciasIdentificadas(String divergenciasIdentificadas) {
    this.divergenciasIdentificadas = divergenciasIdentificadas;
    return this;
  }
  ...
  **/
  ...
  public RecepcaoNFE observacoesGerais(String observacoesGerais) {
    this.observacoesGerais = observacoesGerais;
    return this;
  }
