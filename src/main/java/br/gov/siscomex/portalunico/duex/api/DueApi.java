package br.gov.siscomex.portalunico.duex.api;

import br.gov.siscomex.portalunico.duex.model.AtoConcessorio;
import br.gov.siscomex.portalunico.duex.model.DUE;
import br.gov.siscomex.portalunico.duex.model.DUEResumida;
import br.gov.siscomex.portalunico.duex.model.Declaration;
import br.gov.siscomex.portalunico.duex.model.ExigenciaFiscalEstruturada;
import br.gov.siscomex.portalunico.duex.model.Link;
import br.gov.siscomex.portalunico.duex.model.PucomexReturn;
...
public interface DueApi {
    ...
    /**
     * Retorna lista de atos concessórios do tipo suspensão
     *
     */
    @GET
    @Path("/ext/due/{numero-da-due}/drawback/suspensao/atos-concessorios")
    @Produces({"application/json"})
