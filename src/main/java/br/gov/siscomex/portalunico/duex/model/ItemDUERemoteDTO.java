...
@XmlType(name = "ItemDUERemoteDTO", propOrder =
        {"listaPaisDestino", "numero", "valorDaMercadoriaNoLocalDeEmbarqueEmReais", "exportador", "itensDaNotaDeRemessa", "itemDaNotaFiscalDeExportacao", "valorDaMercadoriaNoLocalDeEmbarque", "atributoDestaqueNcmBD", "listaCertificado", "documentosImportacao", "documentosDeTransformacao", "dataDeConversao", "itensDeNotaComplementar", "pesoLiquidoTotal", "valorTotal", "valorDaMercadoriaNaCondicaoDeVenda", "ncm", "nomeImportador", "descricaoDaMercadoria", "calculoTributario", "quantidadeNaUnidadeComercializada", "percentualDeComissaoDoAgente", "descricaoComplementar", "quantidadeNaUnidadeEstatistica", "tratamentosAdministrativos", "exportacaoTemporaria", "listaDeEnquadramentos", "enderecoImportador", "motivoDoTratamentoPrioritario", "codigoCondicaoVenda", "valorFinanciado", "valorDaMercadoriaNaCondicaoDeVendaEmReais", "atributos", "unidadeComercializada"
        })
...
public class ItemDUERemoteDTO {
    ...
    @XmlElement(name = "listaCertificado")
    @ApiModelProperty(value = "Lista de certificados de origem associados ao item.")
    @Valid
    /**
     * Lista de certificados de origem associados ao item.
     **/
    private List<CertificadoDTO> listaCertificado = null;
     ...
     **/
    @JsonProperty("listaCertificado")
    public List<CertificadoDTO> getListaCertificado() {
        return listaCertificado;
    }

    public void setListaCertificado(List<CertificadoDTO> listaCertificado) {
        this.listaCertificado = listaCertificado;
    }

    public ItemDUERemoteDTO listaCertificado(List<CertificadoDTO> listaCertificado) {
        this.listaCertificado = listaCertificado;
        return this;
    }

    public ItemDUERemoteDTO addListaCertificadoItem(CertificadoDTO listaCertificadoItem) {
        this.listaCertificado.add(listaCertificadoItem);
        return this;
    }
    ...
    public String toString() {
        ...
        String sb = "class ItemDUERemoteDTO {\n" +
                ...
                "    listaCertificado: " + toIndentedString(listaCertificado) + "\n" +
