...
public interface RelaoDeAtributosApi {
    ...
    @Produces({"application/json"})
    @ApiOperation(value = "Consulta histórico de versões", notes = "", tags = {"Relação de Atributos"})
    @ApiResponses(value = {
