...
@XmlRootElement(name = "cargaSoltaVeiculo", namespace = "http://www.pucomex.serpro.gov.br/cct")
public class CargaSoltaVeiculo {
     ...
     * {@link TCargaSoltaVeiculo }
     * 
     * 
     */
    public List<TCargaSoltaVeiculo> getCarga() {
        if (carga == null) {
            carga = new ArrayList<TCargaSoltaVeiculo>();
        }
        return this.carga;
    }
